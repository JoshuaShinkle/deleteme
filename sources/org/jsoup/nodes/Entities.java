...
public class Entities {
    ...
    /* renamed from: a */
    public static final char[] f19989a = {',', ';'};

    /* renamed from: b */
    public static final HashMap<String, String> f19990b = new HashMap<>();

    /* renamed from: c */
    public static final Document.OutputSettings f19991c = new Document.OutputSettings();
    ...
    public enum CoreCharset {
        ...
        /* renamed from: a */
        public static CoreCharset m22887a(String str) {
    ...
    public enum EscapeMode {
        ...
        EscapeMode(String str, int i9) throws IOException, NumberFormatException {
            Entities.m22886h(this, str, i9);
        }

        /* renamed from: i */
        public int m22896i(String str) {
        ...
        /* renamed from: j */
        public String m22897j(int i9) {
            int iBinarySearch = Arrays.binarySearch(this.codeKeys, i9);
            if (iBinarySearch < 0) {
                return "";
            }
    ...
    public static /* synthetic */ class C5683a {
        ...
        static {
            ...
            try {
                f20000a[CoreCharset.utf.ordinal()] = 2;
    ...
    /* renamed from: b */
    public static void m22880b(Appendable appendable, EscapeMode escapeMode, int i9) throws IOException {
        String strM22897j = escapeMode.m22897j(i9);
        if (strM22897j != "") {
            appendable.append('&').append(strM22897j).append(';');
        } else {
    ...
    /* renamed from: c */
    public static boolean m22881c(CoreCharset coreCharset, char c9, CharsetEncoder charsetEncoder) {
        int i9 = C5683a.f20000a[coreCharset.ordinal()];
        if (i9 == 1) {
            return c9 < 128;
        }
        if (i9 != 2) {
    ...
    /* renamed from: d */
    public static int m22882d(String str, int[] iArr) {
        String str2 = f19990b.get(str);
        if (str2 != null) {
            iArr[0] = str2.codePointAt(0);
            iArr[1] = str2.codePointAt(1);
            return 2;
        }
        int iM22896i = EscapeMode.extended.m22896i(str);
        if (iM22896i == -1) {
            return 0;
        }
        iArr[0] = iM22896i;
    ...
    */
    public static void m22883e(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z8, boolean z9, boolean z10) {
        EscapeMode escapeModeM22836g = outputSettings.m22836g();
        CharsetEncoder charsetEncoderM22835e = outputSettings.m22835e();
        CoreCharset coreCharset = outputSettings.f19968e;
        ...
        while (iCharCount < length) {
            ...
            if (z9) {
                if (!C4771c.m18986h(iCodePointAt)) {
                    z12 = false;
                    z11 = true;
                ...
                if (c9 != '\"') {
                    if (c9 == '&') {
                        ...
                        if (c9 != '>') {
                            if (c9 != 160) {
                                if (m22881c(coreCharset, c9, charsetEncoderM22835e)) {
                                    appendable.append(c9);
                                } else {
                                    m22880b(appendable, escapeModeM22836g, iCodePointAt);
                                }
                            } else if (escapeModeM22836g != EscapeMode.xhtml) {
                                appendable.append("&nbsp;");
                            } else {
                                appendable.append("&#xa0;");
                            }
                    ...
                    } else if (!z8 || escapeModeM22836g == EscapeMode.xhtml) {
                        appendable.append("&lt;");
                    } else {
                        appendable.append(c9);
                    }
                ...
                if (charsetEncoderM22835e.canEncode(str2)) {
    ...
    /* renamed from: f */
    public static boolean m22884f(String str) {
        return EscapeMode.base.m22896i(str) != -1;
    }

    /* renamed from: g */
    public static boolean m22885g(String str) {
        return EscapeMode.extended.m22896i(str) != -1;
    }

    /* renamed from: h */
    public static void m22886h(EscapeMode escapeMode, String str, int i9) throws IOException, NumberFormatException {
        int i10;
        ...
        C5030a c5030a = new C5030a(str);
        int i11 = 0;
        while (!c5030a.m19634r()) {
            String strM19627k = c5030a.m19627k('=');
            c5030a.m19618a();
            int i12 = Integer.parseInt(c5030a.m19629m(f19989a), 36);
            char cM19633q = c5030a.m19633q();
            c5030a.m19618a();
            if (cM19633q == ',') {
                i10 = Integer.parseInt(c5030a.m19627k(';'), 36);
                c5030a.m19618a();
            } else {
                i10 = -1;
            }
            int i13 = Integer.parseInt(c5030a.m19627k('&'), 36);
            c5030a.m19618a();
            escapeMode.nameKeys[i11] = strM19627k;
            escapeMode.codeVals[i11] = i12;
            escapeMode.codeKeys[i13] = i12;
            escapeMode.nameVals[i13] = strM19627k;
            if (i10 != -1) {
                f19990b.put(strM19627k, new String(new int[]{i12, i10}, 0, 2));
            }
            i11++;
        }
        C4772d.m18999e(i11 == i9, "Unexpected count of entities loaded");
    }
}
