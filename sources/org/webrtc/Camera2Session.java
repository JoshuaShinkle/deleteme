...
class Camera2Session implements CameraSession {
    ...
    public class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m23185d(Camera2Session.TAG, "Capture failed: " + captureFailure);
        }
    }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            ...
            Logging.m23185d(Camera2Session.TAG, "Camera device closed.");
        ...
        public void onOpened(CameraDevice cameraDevice) throws CameraAccessException {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m23185d(Camera2Session.TAG, "Camera opened.");
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i9 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i9 == 3) {
                    ...
                    Logging.m23185d(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m23185d(Camera2Session.TAG, "Auto-focus is not available.");
        }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i9 : iArr) {
                    if (i9 == 1) {
                        ...
                        Logging.m23185d(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i10 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i10 == 1) {
                    ...
                    Logging.m23185d(Camera2Session.TAG, "Using video stabilization.");
                    return;
                }
            }
            Logging.m23185d(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) throws CameraAccessException {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m23185d(Camera2Session.TAG, "Camera capture session configured.");
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new SurfaceTextureHelper.OnTextureFrameAvailableListener() { // from class: org.webrtc.Camera2Session.CaptureSessionCallback.1
                    ...
                    public void onTextureFrameAvailable(int i9, float[] fArr, long j9) {
                        ...
                        if (Camera2Session.this.state != SessionState.RUNNING) {
                            Logging.m23185d(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                        ...
                        float[] fArrRotateTextureMatrix = RendererCommon.rotateTextureMatrix(fArr, -Camera2Session.this.cameraOrientation);
                        CameraSession.Events events = Camera2Session.this.events;
                        Camera2Session camera2Session = Camera2Session.this;
                        events.onTextureFrameCaptured(camera2Session, camera2Session.captureFormat.width, Camera2Session.this.captureFormat.height, i9, fArrRotateTextureMatrix, frameOrientation, j9);
                    }
                });
                Logging.m23185d(Camera2Session.TAG, "Camera device successfully started.");
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i9, int i10, int i11) throws CameraAccessException {
        Logging.m23185d(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        Logging.m23185d(TAG, "Available preview sizes: " + supportedSizes);
        ...
        Logging.m23185d(TAG, "Using capture format: " + this.captureFormat);
    }
    ...
    private void openCamera() throws CameraAccessException {
        checkIsOnCameraThread();
        Logging.m23185d(TAG, "Opening camera " + this.cameraId);
    ...
    private void start() throws CameraAccessException {
        checkIsOnCameraThread();
        Logging.m23185d(TAG, TtmlNode.START);
        try {
            ...
            reportError("getCameraCharacteristics(): " + e9.getMessage());
        }
    }
    ...
    public void stop() {
        Logging.m23185d(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
