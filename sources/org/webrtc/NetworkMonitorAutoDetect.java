...
public class NetworkMonitorAutoDetect extends BroadcastReceiver {
    ...
    public static class NetworkInformation {
        ...
        public NetworkInformation(String str, ConnectionType connectionType, long j9, IPAddress[] iPAddressArr) {
            this.name = str;
    ...
    public static class NetworkState {
        ...
        public NetworkState(boolean z8, int i9, int i10) {
            this.connected = z8;
            this.type = i9;
            this.subtype = i10;
        }
    ...
    public interface Observer {
        ...
        void onNetworkDisconnect(long j9);
    }
    ...
    public class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m23185d(NetworkMonitorAutoDetect.TAG, "Network becomes available: " + network.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m23185d(NetworkMonitorAutoDetect.TAG, "capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m23185d(NetworkMonitorAutoDetect.TAG, "link properties changed: " + linkProperties.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int i9) {
            Logging.m23185d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is about to lose in " + i9 + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m23185d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
    ...
    public NetworkMonitorAutoDetect(Observer observer, Context context) {
        ...
        try {
            ...
            Logging.m23189w(TAG, "Unable to obtain permission to request a cellular network.");
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m23185d(TAG, "Network connectivity changed, type is: " + this.connectionType);
    ...
    public static class ConnectivityManagerDelegate {
        ...
        public NetworkInformation networkToInfo(Network network) {
            ...
            if (linkProperties == null) {
                Logging.m23189w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            }
            if (linkProperties.getInterfaceName() == null) {
                Logging.m23189w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            }
            ...
            if (connectionType == ConnectionType.CONNECTION_UNKNOWN || connectionType == ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                Logging.m23185d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + connectionType + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
            }
        ...
        public IPAddress[] getIPAddresses(LinkProperties linkProperties) {
            ...
            int i9 = 0;
            while (it.hasNext()) {
                iPAddressArr[i9] = new IPAddress(it.next().getAddress().getAddress());
                i9++;
            }
            return iPAddressArr;
        }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m23185d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
