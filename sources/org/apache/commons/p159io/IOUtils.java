...
import org.apache.commons.p159io.output.ByteArrayOutputStream;
...
public class IOUtils {
    ...
    public static boolean contentEquals(InputStream inputStream, InputStream inputStream2) throws IOException {
        ...
        for (int i9 = inputStream.read(); -1 != i9; i9 = inputStream.read()) {
            if (i9 != inputStream2.read()) {
                return false;
            }
        }
    ...
    public static boolean contentEquals(Reader reader, Reader reader2) throws IOException {
        ...
        for (int i9 = reader.read(); -1 != i9; i9 = reader.read()) {
            if (i9 != reader2.read()) {
                return false;
            }
        }
