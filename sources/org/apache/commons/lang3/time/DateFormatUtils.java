...
public class DateFormatUtils {
    ...
    public static String format(long j9, String str) {
        return format(new Date(j9), str, (TimeZone) null, (Locale) null);
    }

    public static String formatUTC(long j9, String str) {
        return format(new Date(j9), str, UTC_TIME_ZONE, (Locale) null);
    }
    ...
    public static String formatUTC(long j9, String str, Locale locale) {
        return format(new Date(j9), str, UTC_TIME_ZONE, locale);
    }

    public static String format(long j9, String str, TimeZone timeZone) {
        return format(new Date(j9), str, timeZone, (Locale) null);
    }
    ...
    public static String format(long j9, String str, Locale locale) {
        return format(new Date(j9), str, (TimeZone) null, locale);
    }
    ...
    public static String format(long j9, String str, TimeZone timeZone, Locale locale) {
        return format(new Date(j9), str, timeZone, locale);
    }
