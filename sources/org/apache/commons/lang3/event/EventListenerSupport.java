...
public class EventListenerSupport<L> implements Serializable {
    ...
    public void addListener(L l9) {
        Validate.notNull(l9, "Listener object cannot be null.", new Object[0]);
        this.listeners.add(l9);
    }
    ...
    public void removeListener(L l9) {
        Validate.notNull(l9, "Listener object cannot be null.", new Object[0]);
        this.listeners.remove(l9);
    }
