...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new C0339a();

    /* renamed from: androidx.customview.view.AbsSavedState$a */
    public static class C0339a implements Parcelable.ClassLoaderCreator<AbsSavedState> {
        ...
        public AbsSavedState[] newArray(int i9) {
            return new AbsSavedState[i9];
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i9) {
        parcel.writeParcelable(this.mSuperState, i9);
    }
