...
public final class Version {
    ...
    public static final class ECBlocks {
        ...
        public ECBlocks(int i9, ECB... ecbArr) {
            this.ecCodewordsPerBlock = i9;
    ...
    private Version(int i9, int[] iArr, ECBlocks... eCBlocksArr) {
    ...
    public static Version decodeVersionInformation(int i9) {
        ...
        while (true) {
            ...
            int i13 = iArr[i11];
            if (i13 == i9) {
                return getVersionForNumber(i11 + 7);
            }
            int iNumBitsDiffering = FormatInformation.numBitsDiffering(i9, i13);
            if (iNumBitsDiffering < i10) {
                i12 = i11 + 7;
                i10 = iNumBitsDiffering;
            }
            i11++;
        }
    }

    public static Version getProvisionalVersionForDimension(int i9) throws FormatException {
        if (i9 % 4 != 1) {
            throw FormatException.getFormatInstance();
        }
        try {
            return getVersionForNumber((i9 - 17) / 4);
        } catch (IllegalArgumentException unused) {
            throw FormatException.getFormatInstance();
        }
    }

    public static Version getVersionForNumber(int i9) {
        if (i9 < 1 || i9 > 40) {
            throw new IllegalArgumentException();
        }
        return VERSIONS[i9 - 1];
    }
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        int i9 = dimensionForVersion - 8;
        bitMatrix.setRegion(i9, 0, 8, 9);
        bitMatrix.setRegion(0, i9, 9, 8);
        int length = this.alignmentPatternCenters.length;
        for (int i10 = 0; i10 < length; i10++) {
            int i11 = this.alignmentPatternCenters[i10] - 2;
            for (int i12 = 0; i12 < length; i12++) {
                if ((i10 != 0 || (i12 != 0 && i12 != length - 1)) && (i10 != length - 1 || i12 != 0)) {
                    bitMatrix.setRegion(this.alignmentPatternCenters[i12] - 2, i11, 5, 5);
                }
            }
        }
        int i13 = dimensionForVersion - 17;
        bitMatrix.setRegion(6, 9, 1, i13);
        bitMatrix.setRegion(9, 6, i13, 1);
        if (this.versionNumber > 6) {
            int i14 = dimensionForVersion - 11;
            bitMatrix.setRegion(i14, 0, 3, 6);
            bitMatrix.setRegion(0, i14, 6, 3);
        }
        return bitMatrix;
    }
