...
public final class WifiResultHandler extends ResultHandler {
    ...
    public int getButtonText(int i9) {
        return C4453R.string.button_wifi;
    }
    ...
    public int getDisplayTitle() {
        return C4453R.string.result_wifi;
    }
    ...
    public void handleButtonPress(int i9) {
        if (i9 == 0) {
            ...
            activity.runOnUiThread(new Runnable() { // from class: com.google.zxing.client.android.result.WifiResultHandler.1
                ...
                public void run() {
                    Toast.makeText(activity.getApplicationContext(), C4453R.string.wifi_changing_network, 0).show();
                }
            });
