...
final class MECARDContactEncoder extends ContactEncoder {
    ...
    public String[] encode(List<String> list, String str, List<String> list2, List<String> list3, List<String> list4, List<String> list5, List<String> list6, String str2) {
        ...
        ContactEncoder.appendUpToUnique(sb, sb2, "N", list, 1, new MECARDNameDisplayFormatter(), mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.append(sb, sb2, "ORG", str, mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.appendUpToUnique(sb, sb2, "ADR", list2, 1, null, mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.appendUpToUnique(sb, sb2, "TEL", list3, Integer.MAX_VALUE, new MECARDTelDisplayFormatter(), mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.appendUpToUnique(sb, sb2, "EMAIL", list5, Integer.MAX_VALUE, null, mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.appendUpToUnique(sb, sb2, "URL", list6, Integer.MAX_VALUE, null, mECARDFieldFormatter, TERMINATOR);
        ContactEncoder.append(sb, sb2, "NOTE", str2, mECARDFieldFormatter, TERMINATOR);
