...
public abstract class PersistedInstallationEntry {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setExpiresInSecs(long j9);
        ...
        public abstract Builder setTokenCreationEpochInSecs(long j9);
    }
    ...
    public PersistedInstallationEntry withAuthToken(String str, long j9, long j10) {
        return toBuilder().setAuthToken(str).setExpiresInSecs(j9).setTokenCreationEpochInSecs(j10).build();
    }
    ...
    public PersistedInstallationEntry withRegisteredFid(String str, String str2, long j9, String str3, long j10) {
        return toBuilder().setFirebaseInstallationId(str).setRegistrationStatus(PersistedInstallation.RegistrationStatus.REGISTERED).setAuthToken(str3).setRefreshToken(str2).setExpiresInSecs(j10).setTokenCreationEpochInSecs(j9).build();
    }
