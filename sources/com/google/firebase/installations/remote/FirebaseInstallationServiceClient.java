...
public class FirebaseInstallationServiceClient {
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            Log.e("ContentValues", "No such package: " + this.context.getPackageName(), e9);
            return null;
        }
    }
    ...
    private URL getFullyQualifiedRequestUri(String str) throws FirebaseInstallationsException {
        try {
            ...
            throw new FirebaseInstallationsException(e9.getMessage(), FirebaseInstallationsException.Status.UNAVAILABLE);
        }
    }
    ...
    private static boolean isSuccessfulResponseCode(int i9) {
