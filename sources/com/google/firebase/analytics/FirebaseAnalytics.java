...
public final class FirebaseAnalytics {
    ...
    public static zzie getScionFrontendApiImplementation(Context context, Bundle bundle) {
        zzag zzagVarZza = zzag.zza(context, (String) null, (String) null, (String) null, bundle);
        if (zzagVarZza == null) {
            return null;
        }
        return new zzb(zzagVarZza);
    }
    ...
    public final Task<String> getAppInstanceId() {
        try {
            String strZzb = zzb();
            return strZzb != null ? Tasks.forResult(strZzb) : Tasks.call(zza(), new zzc(this));
        } catch (Exception e9) {
    ...
    public final String getFirebaseInstanceId() {
        try {
            return (String) Tasks.await(FirebaseInstallations.getInstance().getId(), SsMediaSource.DEFAULT_LIVE_PRESENTATION_DELAY_MS, TimeUnit.MILLISECONDS);
    ...
    public final void setAnalyticsCollectionEnabled(boolean z8) {
        this.zzb.zza(Boolean.valueOf(z8));
    }
