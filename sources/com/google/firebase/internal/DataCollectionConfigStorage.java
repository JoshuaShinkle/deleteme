...
public class DataCollectionConfigStorage {
    ...
    private synchronized void updateDataCollectionDefaultEnabled(boolean z8) {
        if (this.dataCollectionDefaultEnabled != z8) {
            this.dataCollectionDefaultEnabled = z8;
            this.publisher.publish(new Event<>(DataCollectionDefaultChange.class, new DataCollectionDefaultChange(z8)));
        }
    }
