...
public class SettingsController implements SettingsProvider {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson != null) {
                        ...
                        if (SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) || !settingsJson.isExpired(currentTimeMillis)) {
                            try {
                                Logger.getLogger().m17773v("Returning cached settings.");
                                settings = settingsJson;
                            } catch (Exception e9) {
                                e = e9;
                                settings = settingsJson;
                                Logger.getLogger().m17770e("Failed to get cached settings", e);
                                return settings;
                            }
                        } else {
                            Logger.getLogger().m17773v("Cached settings have expired.");
                        }
                    } else {
                        Logger.getLogger().m17770e("Failed to parse cached settings data.", null);
                    }
                } else {
                    Logger.getLogger().m17767d("No cached settings data found.");
                }
            }
        } catch (Exception e10) {
            e = e10;
    ...
    public void logSettings(JSONObject jSONObject, String str) {
        Logger.getLogger().m17767d(str + jSONObject.toString());
    }
