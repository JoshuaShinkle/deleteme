...
final class AutoValue_CrashlyticsReport extends CrashlyticsReport {
    ...
    public static final class Builder extends CrashlyticsReport.Builder {
        ...
        public CrashlyticsReport.Builder setPlatform(int i9) {
            this.platform = Integer.valueOf(i9);
            return this;
        }
    ...
    private AutoValue_CrashlyticsReport(String str, String str2, int i9, String str3, String str4, String str5, CrashlyticsReport.Session session, CrashlyticsReport.FilesPayload filesPayload, CrashlyticsReport.ApplicationExitInfo applicationExitInfo) {
        this.sdkVersion = str;
        this.gmpAppId = str2;
        this.platform = i9;
