...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((((int) (j9 ^ (j9 >>> 32))) ^ 1000003) * 1000003) ^ this.type.hashCode()) * 1000003) ^ this.app.hashCode()) * 1000003) ^ this.device.hashCode()) * 1000003;
        CrashlyticsReport.Session.Event.Log log = this.log;
    ...
    private AutoValue_CrashlyticsReport_Session_Event(long j9, String str, CrashlyticsReport.Session.Event.Application application, CrashlyticsReport.Session.Event.Device device, CrashlyticsReport.Session.Event.Log log) {
        this.timestamp = j9;
        this.type = str;
        this.app = application;
        this.device = device;
