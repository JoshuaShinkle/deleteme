...
public final class ImmutableList<E> implements List<E>, RandomAccess {
    ...
    public boolean add(E e9) {
        return this.immutableList.add(e9);
    }
    ...
    public E get(int i9) {
        return this.immutableList.get(i9);
    }
    ...
    public E set(int i9, E e9) {
        return this.immutableList.set(i9, e9);
    }
    ...
    public List<E> subList(int i9, int i10) {
        return this.immutableList.subList(i9, i10);
    }
    ...
    public void add(int i9, E e9) {
        this.immutableList.add(i9, e9);
    }

    @Override // java.util.List
    public boolean addAll(int i9, Collection<? extends E> collection) {
        return this.immutableList.addAll(i9, collection);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int i9) {
        return this.immutableList.listIterator(i9);
    }

    @Override // java.util.List
    public E remove(int i9) {
        return this.immutableList.remove(i9);
    }
