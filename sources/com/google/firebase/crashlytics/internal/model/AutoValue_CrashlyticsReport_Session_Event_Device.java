...
final class AutoValue_CrashlyticsReport_Session_Event_Device extends CrashlyticsReport.Session.Event.Device {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Device.Builder {
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Device.Builder
        public CrashlyticsReport.Session.Event.Device.Builder setBatteryLevel(Double d9) {
        ...
        public CrashlyticsReport.Session.Event.Device.Builder setBatteryVelocity(int i9) {
            this.batteryVelocity = Integer.valueOf(i9);
            return this;
        }
    ...
    public int hashCode() {
        Double d9 = this.batteryLevel;
        int iHashCode = ((((((((d9 == null ? 0 : d9.hashCode()) ^ 1000003) * 1000003) ^ this.batteryVelocity) * 1000003) ^ (this.proximityOn ? 1231 : 1237)) * 1000003) ^ this.orientation) * 1000003;
        long j9 = this.ramUsed;
    ...
    private AutoValue_CrashlyticsReport_Session_Event_Device(Double d9, int i9, boolean z8, int i10, long j9, long j10) {
        this.batteryLevel = d9;
