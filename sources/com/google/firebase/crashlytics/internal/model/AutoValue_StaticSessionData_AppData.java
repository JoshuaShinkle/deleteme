...
final class AutoValue_StaticSessionData_AppData extends StaticSessionData.AppData {
    ...
    public AutoValue_StaticSessionData_AppData(String str, String str2, String str3, String str4, int i9, DevelopmentPlatformProvider developmentPlatformProvider) {
        if (str == null) {
