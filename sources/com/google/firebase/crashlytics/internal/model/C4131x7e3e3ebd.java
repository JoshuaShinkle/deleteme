...
final class C4131x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            if (str.isEmpty()) {
                return new C4131x7e3e3ebd(this.name, this.importance.intValue(), this.frames);
            }
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder setImportance(int i9) {
    ...
    private C4131x7e3e3ebd(String str, int i9, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList) {
        this.name = str;
        this.importance = i9;
        this.frames = immutableList;
    }
