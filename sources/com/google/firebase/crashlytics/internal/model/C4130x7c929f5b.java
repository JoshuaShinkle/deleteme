...
final class C4130x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            if (str.isEmpty()) {
                return new C4130x7c929f5b(this.name, this.code, this.address.longValue());
            }
    ...
    private C4130x7c929f5b(String str, String str2, long j9) {
        this.name = str;
        this.code = str2;
        this.address = j9;
    }
