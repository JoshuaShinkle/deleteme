...
final class C4129xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (str.isEmpty()) {
                return new C4129xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
            }
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder
        public CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder setOverflowCount(int i9) {
            this.overflowCount = Integer.valueOf(i9);
            return this;
        }
    ...
    private C4129xc2f5febc(String str, String str2, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i9) {
        this.type = str;
        this.reason = str2;
        this.frames = immutableList;
        this.causedBy = exception;
