...
public class GmsRpc {
    ...
    public GmsRpc(FirebaseApp firebaseApp, Metadata metadata, Rpc rpc, UserAgentPublisher userAgentPublisher, HeartBeatInfo heartBeatInfo, FirebaseInstallationsApi firebaseInstallationsApi) {
