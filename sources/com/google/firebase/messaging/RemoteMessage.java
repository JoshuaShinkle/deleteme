...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public RemoteMessage(@SafeParcelable.Param(m17521id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    public final String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f15585TO);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i9) {
        RemoteMessageCreator.writeToParcel(this, parcel, i9);
    }
}
