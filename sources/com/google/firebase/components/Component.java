...
public final class Component<T> {
    ...
    public static <T> Component<T> intoSet(final T t8, Class<T> cls) {
        return intoSetBuilder(cls).factory(new ComponentFactory() { // from class: com.google.firebase.components.b
            ...
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$intoSet$3(t8, componentContainer);
            }
        }).build();
    }
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m17726of(Class<T> cls, final T t8) {
        return builder(cls).factory(new ComponentFactory() { // from class: com.google.firebase.components.e
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$0(t8, componentContainer);
            }
        }).build();
    }
    ...
    public static class Builder<T> {
        ...
        @CanIgnoreReturnValue
        private Builder<T> setInstantiation(int i9) {
    ...
    private Component(String str, Set<Qualified<? super T>> set, Set<Dependency> set2, int i9, int i10, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.name = str;
    ...
    public static <T> Component<T> intoSet(final T t8, Qualified<T> qualified) {
        return intoSetBuilder(qualified).factory(new ComponentFactory() { // from class: com.google.firebase.components.c
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$intoSet$4(t8, componentContainer);
            }
        }).build();
    }
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m17728of(final T t8, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new ComponentFactory() { // from class: com.google.firebase.components.a
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$1(t8, componentContainer);
            }
        }).build();
    }
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m17727of(final T t8, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
        return builder(qualified, qualifiedArr).factory(new ComponentFactory() { // from class: com.google.firebase.components.d
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.lambda$of$2(t8, componentContainer);
            }
        }).build();
    }
