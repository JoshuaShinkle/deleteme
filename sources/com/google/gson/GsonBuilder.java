...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i9, int i10, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            ...
            TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory4 = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i9, i10);
            if (z8) {
                typeAdapterFactoryCreateAdapterFactory3 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i9, i10);
                TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory5 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i9, i10);
    ...
    public GsonBuilder setVersion(double d9) {
        this.excluder = this.excluder.withVersion(d9);
        return this;
    }
