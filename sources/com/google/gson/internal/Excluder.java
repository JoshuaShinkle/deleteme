...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        final boolean z8 = zExcludeClassChecks || excludeClassInStrategy(rawType, true);
        final boolean z9 = zExcludeClassChecks || excludeClassInStrategy(rawType, false);
        if (z8 || z9) {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM25566clone = m25566clone();
        excluderM25566clone.serializeInnerClasses = false;
        return excluderM25566clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM25566clone = m25566clone();
        excluderM25566clone.requireExpose = true;
        return excluderM25566clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z8, boolean z9) {
        ...
        if (z8) {
            ...
            excluderM25566clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z9) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM25566clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM25566clone = m25566clone();
        excluderM25566clone.modifiers = 0;
        for (int i9 : iArr) {
            excluderM25566clone.modifiers = i9 | excluderM25566clone.modifiers;
        }
        return excluderM25566clone;
    }
    ...
    public Excluder withVersion(double d9) {
        Excluder excluderM25566clone = m25566clone();
        excluderM25566clone.version = d9;
        return excluderM25566clone;
    }

    /* renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m25566clone() {
        try {
