    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (int i9 = 0; i9 < length; i9++) {
                C$Gson$Preconditions.checkNotNull(this.typeArguments[i9]);
                C$Gson$Types.checkNotPrimitive(this.typeArguments[i9]);
                Type[] typeArr3 = this.typeArguments;
                typeArr3[i9] = C$Gson$Types.canonicalize(typeArr3[i9]);
            }
        }
        ...
        public String toString() {
            ...
            for (int i9 = 1; i9 < length; i9++) {
                sb.append(", ");
                sb.append(C$Gson$Types.typeToString(this.typeArguments[i9]));
            }
            sb.append(">");
            return sb.toString();
        }
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (cls2.isArray()) {
                    ...
                    if (type2 instanceof ParameterizedType) {
                        ...
                        boolean z8 = !equal(typeResolve4, ownerType);
                        Type[] actualTypeArguments = type2.getActualTypeArguments();
                        int length = actualTypeArguments.length;
                        for (int i9 = 0; i9 < length; i9++) {
                            Type typeResolve5 = resolve(type, cls, actualTypeArguments[i9], map);
                            if (!equal(typeResolve5, actualTypeArguments[i9])) {
                                if (!z8) {
