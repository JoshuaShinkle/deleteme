...
public final class TypeAdapters {
    ...
    public static /* synthetic */ class C429435 {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public void write(JsonWriter jsonWriter, T t8) throws IOException {
            jsonWriter.value(t8 == null ? null : this.constantToName.get(t8));
        }
    }
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read2(JsonReader jsonReader) throws IOException, NumberFormatException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i10 = C429435.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as BigDecimal; at path " + jsonReader.getPreviousPath(), e9);
                }
            }
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as BigInteger; at path " + jsonReader.getPreviousPath(), e9);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as UUID; at path " + jsonReader.getPreviousPath(), e9);
                }
            }
        ...
        TypeAdapter<Currency> typeAdapterNullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    throw new JsonSyntaxException("Failed parsing '" + strNextString + "' as Currency; at path " + jsonReader.getPreviousPath(), e9);
                }
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            ...
            public JsonElement read2(JsonReader jsonReader) throws IOException {
                ...
                switch (C429435.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
