...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (objConstruct instanceof TypeAdapter) {
            ...
            boolean z8 = objConstruct instanceof JsonSerializer;
            if (!z8 && !(objConstruct instanceof JsonDeserializer)) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z8 ? (JsonSerializer) objConstruct : null, objConstruct instanceof JsonDeserializer ? (JsonDeserializer) objConstruct : null, gson, typeToken, null);
        }
