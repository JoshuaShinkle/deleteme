...
public final class RpcUtil {
    ...
    public static <Type extends Message> RpcCallback<Message> generalizeCallback(final RpcCallback<Type> rpcCallback, final Class<Type> cls, final Type type) {
        return new RpcCallback<Message>() { // from class: com.google.i18n.phonenumbers.repackaged.com.google.protobuf.RpcUtil.1
            @Override // com.google.i18n.phonenumbers.repackaged.com.google.protobuf.RpcCallback
    ...
    public static <ParameterType> RpcCallback<ParameterType> newOneTimeCallback(final RpcCallback<ParameterType> rpcCallback) {
        return new RpcCallback<ParameterType>() { // from class: com.google.i18n.phonenumbers.repackaged.com.google.protobuf.RpcUtil.2
