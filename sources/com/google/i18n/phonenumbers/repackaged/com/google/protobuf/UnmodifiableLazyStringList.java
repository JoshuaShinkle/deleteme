...
public class UnmodifiableLazyStringList extends AbstractList<String> implements LazyStringList, RandomAccess {
    ...
    public Iterator<String> iterator() {
        return new Iterator<String>() { // from class: com.google.i18n.phonenumbers.repackaged.com.google.protobuf.UnmodifiableLazyStringList.2
    ...
    public ListIterator<String> listIterator(int i9) {
        return new ListIterator<String>(i9) { // from class: com.google.i18n.phonenumbers.repackaged.com.google.protobuf.UnmodifiableLazyStringList.1
            ListIterator<String> iter;
            final /* synthetic */ int val$index;

            {
                this.val$index = i9;
                this.iter = UnmodifiableLazyStringList.this.list.listIterator(i9);
            }
