...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public PhoneNumber setCountryCode(int i9) {
        ...
        public PhoneNumber setItalianLeadingZero(boolean z8) {
            this.hasItalianLeadingZero = true;
            this.italianLeadingZero_ = z8;
            return this;
        }

        public PhoneNumber setNationalNumber(long j9) {
            this.hasNationalNumber = true;
            this.nationalNumber_ = j9;
            return this;
        }

        public PhoneNumber setNumberOfLeadingZeros(int i9) {
