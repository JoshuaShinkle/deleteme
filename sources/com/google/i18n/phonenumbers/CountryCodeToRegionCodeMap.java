...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList72.add("GQ");
        map.put(Integer.valueOf(PsExtractor.VIDEO_STREAM_MASK), arrayList72);
        ...
        arrayList82.add("RW");
        map.put(Integer.valueOf(SQLiteDatabase.MAX_SQL_CACHE_SIZE), arrayList82);
        ...
        arrayList135.add("FK");
        map.put(Integer.valueOf(ServiceStarter.ERROR_UNKNOWN), arrayList135);
