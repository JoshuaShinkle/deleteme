...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    private <T extends B> T trustedPut(TypeToken<T> typeToken, T t8) {
        return this.backingMap.put(typeToken, t8);
    }
    ...
    public <T extends B> T putInstance(Class<T> cls, T t8) {
        return (T) trustedPut(TypeToken.m17711of((Class) cls), t8);
    }
    ...
    public <T extends B> T putInstance(TypeToken<T> typeToken, T t8) {
        return (T) trustedPut(typeToken.rejectTypeVariables(), t8);
    }
}
