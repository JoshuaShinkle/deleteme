...
final class Types {
    ...
    private static final Joiner COMMA_JOINER = Joiner.m17550on(", ").useForNull("null");
    ...
    public enum ClassOwnership {
        ...
        private static ClassOwnership detectJvmBehavior() {
            ...
            ParameterizedType parameterizedType = (ParameterizedType) C39293.class.getGenericSuperclass();
    ...
    public static final class TypeVariableImpl<D extends GenericDeclaration> {
        ...
        public TypeVariableImpl(D d9, String str, Type[] typeArr) {
            Types.disallowPrimitiveType(typeArr, "bound for type variable");
            this.genericDeclaration = (D) Preconditions.checkNotNull(d9);
    ...
    public static <D extends GenericDeclaration> TypeVariable<D> newArtificialTypeVariable(D d9, String str, Type... typeArr) {
        if (typeArr.length == 0) {
            typeArr = new Type[]{Object.class};
        }
        return newTypeVariableImpl(d9, str, typeArr);
    }
    ...
    private static <D extends GenericDeclaration> TypeVariable<D> newTypeVariableImpl(D d9, String str, Type[] typeArr) {
        return (TypeVariable) Reflection.newProxy(TypeVariable.class, new TypeVariableInvocationHandler(new TypeVariableImpl(d9, str, typeArr)));
    }
