...
class Element extends AccessibleObject implements Member {
    ...
    public <M extends AccessibleObject & Member> Element(M m8) {
        Preconditions.checkNotNull(m8);
        this.accessibleObject = m8;
        this.member = m8;
    }
    ...
    @Override // java.lang.reflect.AccessibleObject
    public final void setAccessible(boolean z8) throws SecurityException {
        this.accessibleObject.setAccessible(z8);
    }
