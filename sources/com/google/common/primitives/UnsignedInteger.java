...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    public static UnsignedInteger valueOf(long j9) {
        Preconditions.checkArgument((4294967295L & j9) == j9, "value (%s) is outside the range for an unsigned integer value", j9);
        return fromIntBits((int) j9);
    }
    ...
    public String toString(int i9) {
        return UnsignedInts.toString(this.value, i9);
    }
    ...
    public static UnsignedInteger valueOf(String str, int i9) {
        return fromIntBits(UnsignedInts.parseUnsignedInt(str, i9));
    }
}
