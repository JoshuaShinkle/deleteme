...
public final class ImmutableNetwork<N, E> extends ConfigurableNetwork<N, E> {
    ...
    private static <N, E> Function<E, N> adjacentNodeFn(final Network<N, E> network, final N n8) {
        return new Function<E, N>() { // from class: com.google.common.graph.ImmutableNetwork.3
            ...
            public N apply(E e9) {
                return network.incidentNodes(e9).adjacentNode(n8);
            }
        };
    }
    ...
    private static <N, E> NetworkConnections<N, E> connectionsOf(Network<N, E> network, N n8) {
        if (!network.isDirected()) {
            Map mapAsMap = Maps.asMap(network.incidentEdges(n8), adjacentNodeFn(network, n8));
        ...
        Map mapAsMap2 = Maps.asMap(network.inEdges(n8), sourceNodeFn(network));
        Map mapAsMap3 = Maps.asMap(network.outEdges(n8), targetNodeFn(network));
    ...
    private static <N, E> Map<E, N> getEdgeToReferenceNode(Network<N, E> network) {
        ...
        for (E e9 : network.edges()) {
            builder.put(e9, network.incidentNodes(e9).nodeU());
        }
    ...
    private static <N, E> Function<E, N> sourceNodeFn(final Network<N, E> network) {
        return new Function<E, N>() { // from class: com.google.common.graph.ImmutableNetwork.1
            @Override // com.google.common.base.Function
            public N apply(E e9) {
                return network.incidentNodes(e9).source();
            }
        };
    }
    ...
    private static <N, E> Function<E, N> targetNodeFn(final Network<N, E> network) {
        return new Function<E, N>() { // from class: com.google.common.graph.ImmutableNetwork.2
            @Override // com.google.common.base.Function
            public N apply(E e9) {
                return network.incidentNodes(e9).target();
            }
        };
    }
