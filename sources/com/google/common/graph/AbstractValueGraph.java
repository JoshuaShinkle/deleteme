    ...
    public Graph<N> asGraph() {
        return new AbstractGraph<N>() { // from class: com.google.common.graph.AbstractValueGraph.1
            ...
            public Set<N> adjacentNodes(N n8) {
                return AbstractValueGraph.this.adjacentNodes(n8);
            }
            ...
            public int degree(N n8) {
                return AbstractValueGraph.this.degree(n8);
            }
            ...
            public int inDegree(N n8) {
                return AbstractValueGraph.this.inDegree(n8);
            }
            ...
            public int outDegree(N n8) {
                return AbstractValueGraph.this.outDegree(n8);
            }

            @Override // com.google.common.graph.PredecessorsFunction
            public /* bridge */ /* synthetic */ Iterable predecessors(Object obj) {
                return predecessors((C38411) obj);
            }

            @Override // com.google.common.graph.SuccessorsFunction
            public /* bridge */ /* synthetic */ Iterable successors(Object obj) {
                return successors((C38411) obj);
            }

            @Override // com.google.common.graph.BaseGraph, com.google.common.graph.PredecessorsFunction
            public Set<N> predecessors(N n8) {
                return AbstractValueGraph.this.predecessors((AbstractValueGraph) n8);
            }

            @Override // com.google.common.graph.BaseGraph, com.google.common.graph.SuccessorsFunction
            public Set<N> successors(N n8) {
                return AbstractValueGraph.this.successors((AbstractValueGraph) n8);
            }
        };
    }
