...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
    ...
    private NetworkBuilder(boolean z8) {
        super(z8);
    ...
    public NetworkBuilder<N, E> allowsParallelEdges(boolean z8) {
        this.allowsParallelEdges = z8;
        return this;
    }

    public NetworkBuilder<N, E> allowsSelfLoops(boolean z8) {
        this.allowsSelfLoops = z8;
        return this;
    }
    ...
    public NetworkBuilder<N, E> expectedEdgeCount(int i9) {
        this.expectedEdgeCount = Optional.m17551of(Integer.valueOf(Graphs.checkNonNegative(i9)));
        return this;
    }

    public NetworkBuilder<N, E> expectedNodeCount(int i9) {
        this.expectedNodeCount = Optional.m17551of(Integer.valueOf(Graphs.checkNonNegative(i9)));
        return this;
    }
