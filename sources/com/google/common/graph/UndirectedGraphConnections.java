...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* renamed from: of */
    public static <N, V> UndirectedGraphConnections<N, V> m17674of() {
    ...
    public V addSuccessor(N n8, V v8) {
        return this.adjacentNodeValues.put(n8, v8);
    }
    ...
    @Override // com.google.common.graph.GraphConnections
    public V removeSuccessor(N n8) {
        return this.adjacentNodeValues.remove(n8);
    }
    ...
    @Override // com.google.common.graph.GraphConnections
    public V value(N n8) {
        return this.adjacentNodeValues.get(n8);
    }
}
