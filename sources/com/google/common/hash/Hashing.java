...
public final class Hashing {
    ...
    public static final class LinearCongruentialGenerator {
        ...
        public LinearCongruentialGenerator(long j9) {
            this.state = j9;
        }
    ...
    public static int checkPositiveAndMakeMultipleOf32(int i9) {
    ...
    public static HashCode combineOrdered(Iterable<HashCode> iterable) {
        ...
        while (it2.hasNext()) {
            ...
            for (int i9 = 0; i9 < bArrAsBytes.length; i9++) {
                bArr[i9] = (byte) ((bArr[i9] * 37) ^ bArrAsBytes[i9]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }
    ...
    public static HashCode combineUnordered(Iterable<HashCode> iterable) {
        ...
        while (it2.hasNext()) {
            ...
            Preconditions.checkArgument(bArrAsBytes.length == iBits, "All hashcodes must have the same bit length.");
            for (int i9 = 0; i9 < bArrAsBytes.length; i9++) {
                bArr[i9] = (byte) (bArr[i9] + bArrAsBytes[i9]);
            }
        }
        return HashCode.fromBytesNoCopy(bArr);
    }
    ...
    public static HashFunction goodFastHash(int i9) {
        int iCheckPositiveAndMakeMultipleOf32 = checkPositiveAndMakeMultipleOf32(i9);
        ...
        int i10 = (iCheckPositiveAndMakeMultipleOf32 + 127) / 128;
        HashFunction[] hashFunctionArr = new HashFunction[i10];
        hashFunctionArr[0] = Murmur3_128HashFunction.GOOD_FAST_HASH_128;
        int i11 = GOOD_FAST_HASH_SEED;
        for (int i12 = 1; i12 < i10; i12++) {
            i11 += 1500450271;
            hashFunctionArr[i12] = murmur3_128(i11);
        }
    ...
    public static HashFunction murmur3_32(int i9) {
        return new Murmur3_32HashFunction(i9);
    }
    ...
    public static int consistentHash(long j9, int i9) {
        ...
        LinearCongruentialGenerator linearCongruentialGenerator = new LinearCongruentialGenerator(j9);
        while (true) {
            int iNextDouble = (int) ((i10 + 1) / linearCongruentialGenerator.nextDouble());
            if (iNextDouble < 0 || iNextDouble >= i9) {
                break;
            }
            i10 = iNextDouble;
        }
    ...
    public static HashFunction sipHash24(long j9, long j10) {
        return new SipHashFunction(2, 4, j9, j10);
    }
