...
abstract class Striped64 extends Number {
    ...
    public static final class Cell {
        ...
        /* renamed from: p0 */
        volatile long f15401p0;

        /* renamed from: p1 */
        volatile long f15402p1;

        /* renamed from: p2 */
        volatile long f15403p2;

        /* renamed from: p3 */
        volatile long f15404p3;

        /* renamed from: p4 */
        volatile long f15405p4;

        /* renamed from: p5 */
        volatile long f15406p5;

        /* renamed from: p6 */
        volatile long f15407p6;

        /* renamed from: q0 */
        volatile long f15408q0;

        /* renamed from: q1 */
        volatile long f15409q1;

        /* renamed from: q2 */
        volatile long f15410q2;

        /* renamed from: q3 */
        volatile long f15411q3;

        /* renamed from: q4 */
        volatile long f15412q4;

        /* renamed from: q5 */
        volatile long f15413q5;

        /* renamed from: q6 */
        volatile long f15414q6;
        volatile long value;
    ...
    /* renamed from: fn */
    abstract long mo17561fn(long j9, long j10);
        ...
        while (true) {
            ...
            if (cellArr != null && (length = cellArr.length) > 0) {
                ...
                if (cell == null) {
                    ...
                    long j10 = cell.value;
                    if (cell.cas(j10, mo17561fn(j10, j9))) {
                        return;
                    }
                ...
                long j11 = this.base;
                if (casBase(j11, mo17561fn(j11, j9))) {
                    return;
                }
            }
        }
