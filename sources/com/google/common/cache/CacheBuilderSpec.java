...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m17556on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m17556on('=').trimResults();
    ...
    public static /* synthetic */ class C35891 {
    ...
    public static class AccessDurationParser extends DurationParser {
        ...
        public void parseDuration(CacheBuilderSpec cacheBuilderSpec, long j9, TimeUnit timeUnit) {
            Preconditions.checkArgument(cacheBuilderSpec.accessExpirationTimeUnit == null, "expireAfterAccess already set");
            cacheBuilderSpec.accessExpirationDuration = j9;
    ...
    public static class ConcurrencyLevelParser extends IntegerParser {
        ...
        public void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i9) {
            ...
            cacheBuilderSpec.concurrencyLevel = Integer.valueOf(i9);
        }
    }
    ...
    public static abstract class DurationParser implements ValueParser {
        ...
        public abstract void parseDuration(CacheBuilderSpec cacheBuilderSpec, long j9, TimeUnit timeUnit);
    }
    ...
    public static class InitialCapacityParser extends IntegerParser {
        ...
        public void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i9) {
            ...
            cacheBuilderSpec.initialCapacity = Integer.valueOf(i9);
        }
    }
    ...
    public static abstract class IntegerParser implements ValueParser {
        ...
        public void parse(CacheBuilderSpec cacheBuilderSpec, String str, String str2) {
            ...
            try {
                ...
                throw new IllegalArgumentException(CacheBuilderSpec.format("key %s value set to %s, must be integer", str, str2), e9);
            }
        }

        public abstract void parseInteger(CacheBuilderSpec cacheBuilderSpec, int i9);
    }
    ...
    public static abstract class LongParser implements ValueParser {
        ...
        public abstract void parseLong(CacheBuilderSpec cacheBuilderSpec, long j9);
    }

    public static class MaximumSizeParser extends LongParser {
        @Override // com.google.common.cache.CacheBuilderSpec.LongParser
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j9) {
    ...
    public static class MaximumWeightParser extends LongParser {
        ...
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j9) {
            ...
            Preconditions.checkArgument(l9 == null, "maximum weight was already set to ", l9);
    ...
    public static class RefreshDurationParser extends DurationParser {
        ...
        public void parseDuration(CacheBuilderSpec cacheBuilderSpec, long j9, TimeUnit timeUnit) {
            ...
            cacheBuilderSpec.refreshDuration = j9;
    ...
    public static class WriteDurationParser extends DurationParser {
        ...
        public void parseDuration(CacheBuilderSpec cacheBuilderSpec, long j9, TimeUnit timeUnit) {
            ...
            cacheBuilderSpec.writeExpirationDuration = j9;
    ...
    private static Long durationInNanos(long j9, TimeUnit timeUnit) {
        if (timeUnit == null) {
            return null;
        }
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        Long l9 = this.maximumSize;
        if (l9 != null) {
            cacheBuilderNewBuilder.maximumSize(l9.longValue());
        }
        Long l10 = this.maximumWeight;
        if (l10 != null) {
            cacheBuilderNewBuilder.maximumWeight(l10.longValue());
        }
        ...
        if (strength != null) {
            if (C35891.$SwitchMap$com$google$common$cache$LocalCache$Strength[strength.ordinal()] != 1) {
        ...
        if (strength2 != null) {
            int i9 = C35891.$SwitchMap$com$google$common$cache$LocalCache$Strength[strength2.ordinal()];
            if (i9 == 1) {
