...
public final class Stats implements Serializable {
    ...
    /* renamed from: of */
    public static Stats m17678of(Iterable<? extends Number> iterable) {
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j9++;
            dDoubleValue = (Doubles.isFinite(dDoubleValue2) && Doubles.isFinite(dDoubleValue)) ? dDoubleValue + ((dDoubleValue2 - dDoubleValue) / j9) : StatsAccumulator.calculateNewMeanNonFinite(dDoubleValue, dDoubleValue2);
        }
        return dDoubleValue;
    }

    /* renamed from: of */
    public static Stats m17679of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m17680of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i9 = 1; i9 < dArr.length; i9++) {
            double d9 = dArr[i9];
            dCalculateNewMeanNonFinite = (Doubles.isFinite(d9) && Doubles.isFinite(dCalculateNewMeanNonFinite)) ? dCalculateNewMeanNonFinite + ((d9 - dCalculateNewMeanNonFinite) / (i9 + 1)) : StatsAccumulator.calculateNewMeanNonFinite(dCalculateNewMeanNonFinite, d9);
        }
        return dCalculateNewMeanNonFinite;
    }

    /* renamed from: of */
    public static Stats m17681of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m17682of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
