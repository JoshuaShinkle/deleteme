...
public abstract class AbstractScheduledService implements Service {
    ...
    public static abstract class CustomScheduler extends Scheduler {
        ...
        public class ReschedulableCallable extends ForwardingFuture<Void> implements Callable<Void> {
            ...
            public boolean cancel(boolean z8) {
                this.lock.lock();
                try {
                    return this.currentFuture.cancel(z8);
                } finally {
                    this.lock.unlock();
                }
            }
        ...
        public static final class Schedule {
            ...
            public Schedule(long j9, TimeUnit timeUnit) {
                this.delay = j9;
    ...
    public static abstract class Scheduler {
        ...
        public static Scheduler newFixedDelaySchedule(final long j9, final long j10, final TimeUnit timeUnit) {
            ...
            return new Scheduler() { // from class: com.google.common.util.concurrent.AbstractScheduledService.Scheduler.1
                ...
                public Future<?> schedule(AbstractService abstractService, ScheduledExecutorService scheduledExecutorService, Runnable runnable) {
                    return scheduledExecutorService.scheduleWithFixedDelay(runnable, j9, j10, timeUnit);
                }
            };
        }

        public static Scheduler newFixedRateSchedule(final long j9, final long j10, final TimeUnit timeUnit) {
            Preconditions.checkNotNull(timeUnit);
            ...
            return new Scheduler() { // from class: com.google.common.util.concurrent.AbstractScheduledService.Scheduler.2
                ...
                @Override // com.google.common.util.concurrent.AbstractScheduledService.Scheduler
                public Future<?> schedule(AbstractService abstractService, ScheduledExecutorService scheduledExecutorService, Runnable runnable) {
                    return scheduledExecutorService.scheduleAtFixedRate(runnable, j9, j10, timeUnit);
                }
            };
        }
    ...
    public final class ServiceDelegate extends AbstractService {
        ...
        public final void doStart() {
            this.executorService = MoreExecutors.renamingDecorator(AbstractScheduledService.this.executor(), new Supplier<String>() { // from class: com.google.common.util.concurrent.AbstractScheduledService.ServiceDelegate.1
                ...
                public String get() {
                    return AbstractScheduledService.this.serviceName() + StringUtils.SPACE + ServiceDelegate.this.state();
                }
            });
