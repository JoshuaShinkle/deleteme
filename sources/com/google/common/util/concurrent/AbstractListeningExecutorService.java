...
public abstract class AbstractListeningExecutorService extends AbstractExecutorService implements ListeningExecutorService {
    ...
    public final <T> RunnableFuture<T> newTaskFor(Runnable runnable, T t8) {
        return TrustedListenableFutureTask.create(runnable, t8);
    }
    ...
    public <T> ListenableFuture<T> submit(Runnable runnable, T t8) {
        return (ListenableFuture) super.submit(runnable, (Runnable) t8);
    }
