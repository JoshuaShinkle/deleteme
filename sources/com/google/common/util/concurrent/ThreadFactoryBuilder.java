...
public final class ThreadFactoryBuilder {
    ...
    public ThreadFactoryBuilder setDaemon(boolean z8) {
        this.daemon = Boolean.valueOf(z8);
        return this;
    }
    ...
    public ThreadFactoryBuilder setPriority(int i9) {
        Preconditions.checkArgument(i9 >= 1, "Thread priority (%s) must be >= %s", i9, 1);
        Preconditions.checkArgument(i9 <= 10, "Thread priority (%s) must be <= %s", i9, 10);
        this.priority = Integer.valueOf(i9);
        return this;
    }
