...
public class CycleDetectingLockFactory {
    ...
    public final class CycleDetectingReentrantLock extends ReentrantLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantLock(LockGraphNode lockGraphNode, boolean z8) {
            super(z8);
    ...
    public final class CycleDetectingReentrantReadWriteLock extends ReentrantReadWriteLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantReadWriteLock(LockGraphNode lockGraphNode, boolean z8) {
            super(z8);
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        static final ImmutableSet<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m17618of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
    ...
    public static class LockGraphNode {
        ...
        public void checkAcquiredLocks(Policy policy, List<LockGraphNode> list) {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                checkAcquiredLock(policy, list.get(i9));
            }
        }
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e9, boolean z8) {
            return this.policy == Policies.DISABLED ? new ReentrantLock(z8) : new CycleDetectingReentrantLock(this.lockGraphNodes.get(e9), z8);
        }

        public ReentrantReadWriteLock newReentrantReadWriteLock(E e9, boolean z8) {
            return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z8) : new CycleDetectingReentrantReadWriteLock(this.lockGraphNodes.get(e9), z8);
        }
    }
    ...
    public static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> cls) {
        ...
        for (E e9 : enumConstants) {
            LockGraphNode lockGraphNode = new LockGraphNode(getLockName(e9));
            arrayListNewArrayListWithCapacity.add(lockGraphNode);
            enumMapNewEnumMap.put((EnumMap) e9, (E) lockGraphNode);
        }
        for (int i10 = 1; i10 < length; i10++) {
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i10)).checkAcquiredLocks(Policies.THROW, arrayListNewArrayListWithCapacity.subList(0, i10));
        }
        while (i9 < length - 1) {
            i9++;
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i9)).checkAcquiredLocks(Policies.DISABLED, arrayListNewArrayListWithCapacity.subList(i9, length));
        }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z8) {
        return this.policy == Policies.DISABLED ? new ReentrantLock(z8) : new CycleDetectingReentrantLock(new LockGraphNode(str), z8);
    }

    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z8) {
        return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z8) : new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z8);
    }
