...
public abstract class AbstractExecutionThreadService implements Service {
                        ...
                        if (isRunning()) {
                            try {
                                ...
                                try {
                                    ...
                                    AbstractExecutionThreadService.logger.log(Level.WARNING, "Error while attempting to shut down the service after failure.", (Throwable) e9);
                                }
                                notifyFailed(th);
                                return;
                            }
    ...
    @Override // com.google.common.util.concurrent.Service
    public final void awaitRunning(long j9, TimeUnit timeUnit) {
        this.delegate.awaitRunning(j9, timeUnit);
    }

    @Override // com.google.common.util.concurrent.Service
    public final void awaitTerminated(long j9, TimeUnit timeUnit) {
