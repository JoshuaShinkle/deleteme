...
public abstract class AbstractService implements Service {
    ...
    public static /* synthetic */ class C39556 {
    ...
    public static final class StateSnapshot {
        ...
        public StateSnapshot(Service.State state, boolean z8, Throwable th) {
            Preconditions.checkArgument(!z8 || state == Service.State.STARTING, "shudownWhenStartupFinishes can only be set if state is STARTING. Got %s instead.", state);
            ...
            this.state = state;
            this.shutdownWhenStartupFinishes = z8;
            this.failure = th;
        }
    }
    ...
    private void enqueueTerminatedEvent(Service.State state) {
        int i9 = C39556.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
        if (i9 == 1) {
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            ...
            switch (C39556.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                case 1:
                case 5:
    ...
    public final void awaitRunning(long j9, TimeUnit timeUnit) throws TimeoutException {
        if (this.monitor.enterWhenUninterruptibly(this.hasReachedRunning, j9, timeUnit)) {
            try {
                checkCurrentState(Service.State.RUNNING);
            } finally {
                this.monitor.leave();
    ...
    public final void awaitTerminated(long j9, TimeUnit timeUnit) throws TimeoutException {
        if (this.monitor.enterWhenUninterruptibly(this.isStopped, j9, timeUnit)) {
            try {
                checkCurrentState(Service.State.TERMINATED);
            } finally {
                this.monitor.leave();
