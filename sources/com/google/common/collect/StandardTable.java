...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        public class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m17552in(collection)));
            }
                    ...
                    if (next.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
                            ...
                            public V setValue(V v8) {
                                return (V) ((Map) next.getValue()).put(Column.this.columnKey, Preconditions.checkNotNull(v8));
                            }
                        };
                    }
                }
        ...
        public class KeySet extends Maps.KeySet<R, V> {
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m17552in(collection))));
            }
        }
        ...
        public class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m17552in(collection)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m17552in(collection))));
            }
        }

        public Column(C c9) {
            this.columnKey = (C) Preconditions.checkNotNull(c9);
        }
        ...
        public V put(R r8, V v8) {
            return (V) StandardTable.this.put(r8, this.columnKey, v8);
        }
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.columnKeySet(), new Function<C, Map<R, V>>() { // from class: com.google.common.collect.StandardTable.ColumnMap.ColumnMapEntrySet.1
                    ...
                    public /* bridge */ /* synthetic */ Object apply(Object obj) {
                        return apply((C37841) obj);
                    }

                    @Override // com.google.common.base.Function
                    public Map<R, V> apply(C c9) {
                        return StandardTable.this.column(c9);
                    }
                });
            }
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public V put(C c9, V v8) {
            ...
            Map<C, V> map = this.backingRowMap;
            return (map == null || map.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, c9, v8) : this.backingRowMap.put(c9, v8);
        }
        ...
        public V remove(Object obj) {
            ...
            V v8 = (V) Maps.safeRemove(mapBackingRowMap, obj);
            maintainEmptyInvariant();
            return v8;
        }
        ...
        public Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>() { // from class: com.google.common.collect.StandardTable.Row.2
                ...
                @Override // com.google.common.collect.ForwardingMapEntry, java.util.Map.Entry
                public V setValue(V v8) {
                    return (V) super.setValue(Preconditions.checkNotNull(v8));
                }
