...
public abstract class FluentIterable<E> implements Iterable<E> {
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.2
            ...
            public Iterator<T> iterator() {
                return Iterators.concat(new AbstractIndexedListIterator<Iterator<? extends T>>(iterableArr.length) { // from class: com.google.common.collect.FluentIterable.2.1
                    ...
                    public Iterator<? extends T> get(int i9) {
                        return iterableArr[i9].iterator();
                    }
                });
            }
        };
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo17545or((Optional<Iterable<E>>) this);
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m17563of() {
        return from(ImmutableList.m17573of());
    }
    ...
    public final <C extends Collection<? super E>> C copyInto(C c9) {
        ...
        if (delegate instanceof Collection) {
            c9.addAll(Collections2.cast(delegate));
        } else {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m17551of(it.next()) : Optional.absent();
    }
    ...
    public final E get(int i9) {
        return (E) Iterables.get(getDelegate(), i9);
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return list.isEmpty() ? Optional.absent() : Optional.m17551of(list.get(list.size() - 1));
        }
        Iterator<E> it = delegate.iterator();
        if (!it.hasNext()) {
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m17551of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
    ...
    public final FluentIterable<E> limit(int i9) {
        return from(Iterables.limit(getDelegate(), i9));
    }
    ...
    public final FluentIterable<E> skip(int i9) {
        return from(Iterables.skip(getDelegate(), i9));
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m17564of(E e9, E... eArr) {
        return from(Lists.asList(e9, eArr));
    }
