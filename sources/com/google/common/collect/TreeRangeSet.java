...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> range) {
            if (!this.complementLowerBoundWindow.isConnected(range)) {
                return ImmutableSortedMap.m17628of();
            }
        ...
        public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> cut, boolean z8) {
            return subMap(Range.upTo(cut, BoundType.forBoolean(z8)));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> cut, boolean z8) {
            return subMap(Range.downTo(cut, BoundType.forBoolean(z8)));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<Cut<C>, Range<C>> subMap(Cut<C> cut, boolean z8, Cut<C> cut2, boolean z9) {
            return subMap(Range.range(cut, BoundType.forBoolean(z8), cut2, BoundType.forBoolean(z9)));
        }
    }
    ...
    public static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> range) {
            return range.isConnected(this.upperBoundWindow) ? new RangesByUpperBound(this.rangesByLowerBound, range.intersection(this.upperBoundWindow)) : ImmutableSortedMap.m17628of();
        }
    ...
    public final class SubRangeSet extends TreeRangeSet<C> {
        ...
        public Range<C> rangeContaining(C c9) {
            ...
            if (this.restriction.contains(c9) && (rangeRangeContaining = TreeRangeSet.this.rangeContaining(c9)) != null) {
        ...
        public RangeSet<C> subRangeSet(Range<C> range) {
            return range.encloses(this.restriction) ? this : range.isConnected(this.restriction) ? new SubRangeSet(this.restriction.intersection(range)) : ImmutableRangeSet.m17613of();
        }
    }
    ...
    public static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        private NavigableMap<Cut<C>, Range<C>> subMap(Range<Cut<C>> range) {
            return !range.isConnected(this.lowerBoundWindow) ? ImmutableSortedMap.m17628of() : new SubRangeSetRangesByLowerBound(this.lowerBoundWindow.intersection(range), this.restriction, this.rangesByLowerBound);
        }
    ...
    public Range<C> rangeContaining(C c9) {
        ...
        Map.Entry<Cut<C>, Range<C>> entryFloorEntry = this.rangesByLowerBound.floorEntry(Cut.belowValue(c9));
        if (entryFloorEntry == null || !entryFloorEntry.getValue().contains(c9)) {
            return null;
        }
        return entryFloorEntry.getValue();
    }
