...
public final class Queues {
    ...
    @Beta
    @GwtIncompatible
    public static <E> int drain(BlockingQueue<E> blockingQueue, Collection<? super E> collection, int i9, long j9, TimeUnit timeUnit) throws InterruptedException {
        Preconditions.checkNotNull(collection);
        long jNanoTime = System.nanoTime() + timeUnit.toNanos(j9);
        int iDrainTo = 0;
        while (iDrainTo < i9) {
            iDrainTo += blockingQueue.drainTo(collection, i9 - iDrainTo);
            if (iDrainTo < i9) {
    ...
    @Beta
    @GwtIncompatible
    public static <E> int drainUninterruptibly(BlockingQueue<E> blockingQueue, Collection<? super E> collection, int i9, long j9, TimeUnit timeUnit) {
        E ePoll;
        Preconditions.checkNotNull(collection);
        long jNanoTime = System.nanoTime() + timeUnit.toNanos(j9);
        int iDrainTo = 0;
    ...
    @GwtIncompatible
    public static <E> ArrayBlockingQueue<E> newArrayBlockingQueue(int i9) {
        return new ArrayBlockingQueue<>(i9);
    }
    ...
    @GwtIncompatible
    public static <E> LinkedBlockingDeque<E> newLinkedBlockingDeque(int i9) {
        return new LinkedBlockingDeque<>(i9);
    }

    @GwtIncompatible
    public static <E> LinkedBlockingQueue<E> newLinkedBlockingQueue(int i9) {
