...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public final class CellSet extends ImmutableSet.Indexed<Table.Cell<R, C, V>> {
        ...
        public Table.Cell<R, C, V> get(int i9) {
            return RegularImmutableTable.this.getCell(i9);
        }
    }
    ...
    public final class Values extends ImmutableList<V> {
        ...
        public V get(int i9) {
            return (V) RegularImmutableTable.this.getValue(i9);
        }
    ...
    public abstract Table.Cell<R, C, V> getCell(int i9);

    public abstract V getValue(int i9);

    @Override // com.google.common.collect.ImmutableTable, com.google.common.collect.AbstractTable
    public final ImmutableSet<Table.Cell<R, C, V>> createCellSet() {
        return isEmpty() ? ImmutableSet.m17615of() : new CellSet();
    }

    @Override // com.google.common.collect.ImmutableTable, com.google.common.collect.AbstractTable
    public final ImmutableCollection<V> createValues() {
        return isEmpty() ? ImmutableList.m17573of() : new Values();
    }
