...
class FilteredKeyMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    public Collection<V> get(K k9) {
        return this.keyPredicate.apply(k9) ? this.unfiltered.get(k9) : this.unfiltered instanceof SetMultimap ? new AddRejectingSet(k9) : new AddRejectingList(k9);
    }
    ...
    public Collection<V> unmodifiableEmptyCollection() {
        return this.unfiltered instanceof SetMultimap ? ImmutableSet.m17615of() : ImmutableList.m17573of();
    }

    public static class AddRejectingSet<K, V> extends ForwardingSet<V> {
        final K key;

        public AddRejectingSet(K k9) {
            this.key = k9;
        }
