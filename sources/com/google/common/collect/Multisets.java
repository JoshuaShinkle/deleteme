...
public final class Multisets {
    ...
    public static final class FilteredMultiset<E> extends AbstractMultiset<E> {
        ...
        public int add(E e9, int i9) {
            Preconditions.checkArgument(this.predicate.apply(e9), "Element %s does not match predicate %s", e9, this.predicate);
            return this.unfiltered.add(e9, i9);
        }
        ...
        public int remove(Object obj, int i9) {
            ...
            if (contains(obj)) {
                return this.unfiltered.remove(obj, i9);
            }
            return 0;
        }
    ...
    public static <E> Multiset.Entry<E> immutableEntry(E e9, int i9) {
    ...
    public static <E> int setCountImpl(Multiset<E> multiset, E e9, int i9) {
        CollectPreconditions.checkNonnegative(i9, "count");
        int iCount = multiset.count(e9);
        int i10 = i9 - iCount;
        if (i10 > 0) {
            multiset.add(e9, i10);
        } else if (i10 < 0) {
            multiset.remove(e9, -i10);
        }
        return iCount;
    }
    ...
    public static <E> boolean setCountImpl(Multiset<E> multiset, E e9, int i9, int i10) {
        CollectPreconditions.checkNonnegative(i9, "oldCount");
        CollectPreconditions.checkNonnegative(i10, "newCount");
        if (multiset.count(e9) != i9) {
            return false;
        }
        multiset.setCount(e9, i10);
        return true;
    }
