...
public abstract class ForwardingSortedMultiset<E> extends ForwardingMultiset<E> implements SortedMultiset<E> {
    ...
    public SortedMultiset<E> headMultiset(E e9, BoundType boundType) {
        return delegate().headMultiset(e9, boundType);
    }
    ...
    public SortedMultiset<E> standardSubMultiset(E e9, BoundType boundType, E e10, BoundType boundType2) {
    ...
    public SortedMultiset<E> subMultiset(E e9, BoundType boundType, E e10, BoundType boundType2) {
        return delegate().subMultiset(e9, boundType, e10, boundType2);
    }

    @Override // com.google.common.collect.SortedMultiset
    public SortedMultiset<E> tailMultiset(E e9, BoundType boundType) {
        return delegate().tailMultiset(e9, boundType);
    }
