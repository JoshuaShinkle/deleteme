...
public abstract class TreeTraverser<T> {
    ...
    public final class BreadthFirstIterator extends UnmodifiableIterator<T> implements PeekingIterator<T> {
        ...
        public BreadthFirstIterator(T t8) {
    ...
    public final class PostOrderIterator extends AbstractIterator<T> {
        ...
        public PostOrderIterator(T t8) {
            ...
            arrayDeque.addLast(expand(t8));
        }

        private PostOrderNode<T> expand(T t8) {
            return new PostOrderNode<>(t8, TreeTraverser.this.children(t8).iterator());
        }
    ...
    public static final class PostOrderNode<T> {
        ...
        public PostOrderNode(T t8, Iterator<T> it) {
            this.root = (T) Preconditions.checkNotNull(t8);
    ...
    public static <T> TreeTraverser<T> using(final Function<T, ? extends Iterable<T>> function) {
        ...
        return new TreeTraverser<T>() { // from class: com.google.common.collect.TreeTraverser.1
            ...
            public Iterable<T> children(T t8) {
                return (Iterable) function.apply(t8);
            }
        };
    }

    public final FluentIterable<T> breadthFirstTraversal(final T t8) {
    ...
    public final FluentIterable<T> postOrderTraversal(final T t8) {
        Preconditions.checkNotNull(t8);
        return new FluentIterable<T>() { // from class: com.google.common.collect.TreeTraverser.3
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Iterable
            public UnmodifiableIterator<T> iterator() {
                return TreeTraverser.this.postOrderIterator(t8);
            }
        };
    }
    ...
    public final FluentIterable<T> preOrderTraversal(final T t8) {
        Preconditions.checkNotNull(t8);
        return new FluentIterable<T>() { // from class: com.google.common.collect.TreeTraverser.2
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Iterable
            public UnmodifiableIterator<T> iterator() {
                return TreeTraverser.this.preOrderIterator(t8);
            }
        };
    }
}
