...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(Object obj, V v8) {
            return this.predicate.apply(Maps.immutableEntry(obj, v8));
        }
        ...
        public V get(Object obj) {
            V v8 = this.unfiltered.get(obj);
            if (v8 == null || !apply(obj, v8)) {
                return null;
            }
            return v8;
        }
        ...
        public V put(K k9, V v8) {
            Preconditions.checkArgument(apply(k9, v8));
            return this.unfiltered.put(k9, v8);
        }
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> biMap, X x8) {
            Y y8 = biMap.get(x8);
            Preconditions.checkArgument(y8 != null, "No non-null mapping present for input: %s", x8);
            return y8;
        }
    ...
    public static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(K k9) {
            return forward().floorEntry(k9);
        }

        @Override // java.util.NavigableMap
        public K ceilingKey(K k9) {
            return forward().floorKey(k9);
        }
        ...
        public Map.Entry<K, V> floorEntry(K k9) {
            return forward().ceilingEntry(k9);
        }

        @Override // java.util.NavigableMap
        public K floorKey(K k9) {
            return forward().ceilingKey(k9);
        }
        ...
        public NavigableMap<K, V> headMap(K k9, boolean z8) {
            return forward().tailMap(k9, z8).descendingMap();
        }

        @Override // java.util.NavigableMap
        public Map.Entry<K, V> higherEntry(K k9) {
            return forward().lowerEntry(k9);
        }

        @Override // java.util.NavigableMap
        public K higherKey(K k9) {
            return forward().lowerKey(k9);
        }
        ...
        public Map.Entry<K, V> lowerEntry(K k9) {
            return forward().higherEntry(k9);
        }

        @Override // java.util.NavigableMap
        public K lowerKey(K k9) {
            return forward().higherKey(k9);
        }
        ...
        public NavigableMap<K, V> subMap(K k9, boolean z8, K k10, boolean z9) {
            return forward().subMap(k10, z9, k9, z8).descendingMap();
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k9, boolean z8) {
            return forward().headMap(k9, z8).descendingMap();
        }
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public V forcePut(K k9, V v8) {
            Preconditions.checkArgument(apply(k9, v8));
            return unfiltered().forcePut(k9, v8);
        }
                    ...
                    public Map.Entry<K, V> transform(final Map.Entry<K, V> entry) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
                            ...
                            public V setValue(V v8) {
                                Preconditions.checkArgument(FilteredEntryMap.this.apply(getKey(), v8));
    ...
    public static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(K k9, boolean z8) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.headMap(k9, z8), (Predicate) this.entryPredicate);
        }
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public V put(K k9, V v8) {
            return this.filteredDelegate.put(k9, v8);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(K k9, boolean z8, K k10, boolean z9) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.subMap(k9, z8, k10, z9), (Predicate) this.entryPredicate);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k9, boolean z8) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.tailMap(k9, z8), (Predicate) this.entryPredicate);
        }
    ...
    public static class FilteredEntrySortedMap<K, V> extends FilteredEntryMap<K, V> implements SortedMap<K, V> {
        ...
        public class SortedKeySet extends FilteredEntryMap<K, V>.KeySet implements SortedSet<K> {
            ...
            public SortedSet<K> headSet(K k9) {
                return (SortedSet) FilteredEntrySortedMap.this.headMap(k9).keySet();
            }
            ...
            public SortedSet<K> subSet(K k9, K k10) {
                return (SortedSet) FilteredEntrySortedMap.this.subMap(k9, k10).keySet();
            }

            @Override // java.util.SortedSet
            public SortedSet<K> tailSet(K k9) {
                return (SortedSet) FilteredEntrySortedMap.this.tailMap(k9).keySet();
            }
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(K k9) {
            return new FilteredEntrySortedMap(sortedMap().headMap(k9), this.predicate);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(K k9, K k10) {
            return new FilteredEntrySortedMap(sortedMap().subMap(k9, k10), this.predicate);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(K k9) {
            return new FilteredEntrySortedMap(sortedMap().tailMap(k9), this.predicate);
        }
    ...
    public static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(K k9, boolean z8) {
            return Maps.asMap((NavigableSet) this.set.headSet(k9, z8), (Function) this.function);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(K k9, boolean z8, K k10, boolean z9) {
            return Maps.asMap((NavigableSet) this.set.subSet(k9, z8, k10, z9), (Function) this.function);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k9, boolean z8) {
            return Maps.asMap((NavigableSet) this.set.tailSet(k9, z8), (Function) this.function);
        }
    }
    ...
    public static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K> {
        ...
        @Override // java.util.NavigableSet
        public K floor(K k9) {
            return map().floorKey(k9);
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> headSet(K k9, boolean z8) {
            return map().headMap(k9, z8).navigableKeySet();
        }

        @Override // java.util.NavigableSet
        public K higher(K k9) {
            return map().higherKey(k9);
        }

        @Override // java.util.NavigableSet
        public K lower(K k9) {
            return map().lowerKey(k9);
        }
        ...
        public NavigableSet<K> subSet(K k9, boolean z8, K k10, boolean z9) {
            return map().subMap(k9, z8, k10, z9).navigableKeySet();
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> tailSet(K k9, boolean z8) {
            return map().tailMap(k9, z8).navigableKeySet();
        }
    ...
    public static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(K k9) {
            return Maps.asMap((SortedSet) backingSet().headSet(k9), (Function) this.function);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(K k9, K k10) {
            return Maps.asMap((SortedSet) backingSet().subSet(k9, k10), (Function) this.function);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(K k9) {
            return Maps.asMap((SortedSet) backingSet().tailSet(k9), (Function) this.function);
        }
    ...
    public static class SortedKeySet<K, V> extends KeySet<K, V> implements SortedSet<K> {
        ...
        public SortedSet<K> headSet(K k9) {
            return new SortedKeySet(map().headMap(k9));
        }
        ...
        public SortedSet<K> subSet(K k9, K k10) {
            return new SortedKeySet(map().subMap(k9, k10));
        }

        public SortedSet<K> tailSet(K k9) {
            return new SortedKeySet(map().tailMap(k9));
        }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        public Map.Entry<K, V2> ceilingEntry(K k9) {
            return transformEntry(fromMap().ceilingEntry(k9));
        }

        @Override // java.util.NavigableMap
        public K ceilingKey(K k9) {
            return fromMap().ceilingKey(k9);
        }
        ...
        public Map.Entry<K, V2> floorEntry(K k9) {
            return transformEntry(fromMap().floorEntry(k9));
        }

        @Override // java.util.NavigableMap
        public K floorKey(K k9) {
            return fromMap().floorKey(k9);
        }
        ...
        public Map.Entry<K, V2> higherEntry(K k9) {
            return transformEntry(fromMap().higherEntry(k9));
        }

        @Override // java.util.NavigableMap
        public K higherKey(K k9) {
            return fromMap().higherKey(k9);
        }
        ...
        public Map.Entry<K, V2> lowerEntry(K k9) {
            return transformEntry(fromMap().lowerEntry(k9));
        }

        @Override // java.util.NavigableMap
        public K lowerKey(K k9) {
            return fromMap().lowerKey(k9);
        }
        ...
        public NavigableMap<K, V2> subMap(K k9, boolean z8, K k10, boolean z9) {
            return Maps.transformEntries((NavigableMap) fromMap().subMap(k9, z8, k10, z9), (EntryTransformer) this.transformer);
        }
        ...
        public NavigableMap<K, V2> headMap(K k9, boolean z8) {
            return Maps.transformEntries((NavigableMap) fromMap().headMap(k9, z8), (EntryTransformer) this.transformer);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(K k9, boolean z8) {
            return Maps.transformEntries((NavigableMap) fromMap().tailMap(k9, z8), (EntryTransformer) this.transformer);
        }
    ...
    public static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2> {
        ...
        public SortedMap<K, V2> headMap(K k9) {
            return Maps.transformEntries((SortedMap) fromMap().headMap(k9), (EntryTransformer) this.transformer);
        }
        ...
        public SortedMap<K, V2> subMap(K k9, K k10) {
            return Maps.transformEntries((SortedMap) fromMap().subMap(k9, k10), (EntryTransformer) this.transformer);
        }

        public SortedMap<K, V2> tailMap(K k9) {
            return Maps.transformEntries((SortedMap) fromMap().tailMap(k9), (EntryTransformer) this.transformer);
        }
    }
    ...
    public static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable {
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> ceilingEntry(K k9) {
            return Maps.unmodifiableOrNull(this.delegate.ceilingEntry(k9));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> floorEntry(K k9) {
            return Maps.unmodifiableOrNull(this.delegate.floorEntry(k9));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> higherEntry(K k9) {
            return Maps.unmodifiableOrNull(this.delegate.higherEntry(k9));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> lowerEntry(K k9) {
            return Maps.unmodifiableOrNull(this.delegate.lowerEntry(k9));
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(K k9, boolean z8) {
            return Maps.unmodifiableNavigableMap(this.delegate.headMap(k9, z8));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(K k9, boolean z8, K k10, boolean z9) {
            return Maps.unmodifiableNavigableMap(this.delegate.subMap(k9, z8, k10, z9));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(K k9, boolean z8) {
            return Maps.unmodifiableNavigableMap(this.delegate.tailMap(k9, z8));
        }
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        private ValueDifferenceImpl(V v8, V v9) {
            this.left = v8;
            this.right = v9;
        }

        public static <V> MapDifference.ValueDifference<V> create(V v8, V v9) {
            return new ValueDifferenceImpl(v8, v9);
        }
    ...
    public static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() { // from class: com.google.common.collect.Maps.7
            ...
            public V2 transformEntry(K k9, V1 v12) {
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.1
            ...
            public /* bridge */ /* synthetic */ Object transform(Object obj) {
                return transform((C37131<K, V>) obj);
            }

            @Override // com.google.common.collect.TransformedIterator
            public Map.Entry<K, V> transform(K k9) {
                return Maps.immutableEntry(k9, function.apply(k9));
            }
        };
    }

    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, final K k9) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.8
            @Override // com.google.common.base.Function
            public V2 apply(V1 v12) {
                return (V2) entryTransformer.transformEntry(k9, v12);
            }
        };
    }

    public static int capacity(int i9) {
        if (i9 < 3) {
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(K k9, V v8) {
    ...
    public static <K, V> HashMap<K, V> newHashMapWithExpectedSize(int i9) {
        return new HashMap<>(capacity(i9));
    }
    ...
    public static <K, V> LinkedHashMap<K, V> newLinkedHashMapWithExpectedSize(int i9) {
        return new LinkedHashMap<>(capacity(i9));
    }
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.4
            ...
            public SortedSet<E> headSet(E e9) {
                return Maps.removeOnlySortedSet(super.headSet(e9));
            }

            @Override // com.google.common.collect.ForwardingSortedSet, java.util.SortedSet
            public SortedSet<E> subSet(E e9, E e10) {
                return Maps.removeOnlySortedSet(super.subSet(e9, e10));
            }

            @Override // com.google.common.collect.ForwardingSortedSet, java.util.SortedSet
            public SortedSet<E> tailSet(E e9) {
                return Maps.removeOnlySortedSet(super.tailSet(e9));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> headSet(E e9, boolean z8) {
                return Maps.removeOnlyNavigableSet(super.headSet(e9, z8));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> subSet(E e9, boolean z8, E e10, boolean z9) {
                return Maps.removeOnlyNavigableSet(super.subSet(e9, z8, e10, z9));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> tailSet(E e9, boolean z8) {
                return Maps.removeOnlyNavigableSet(super.tailSet(e9, z8));
            }
