...
final class DescendingImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    public ImmutableSortedMultiset<E> headMultiset(E e9, BoundType boundType) {
        return this.forward.tailMultiset((ImmutableSortedMultiset<E>) e9, boundType).descendingMultiset();
    }

    @Override // com.google.common.collect.ImmutableSortedMultiset, com.google.common.collect.SortedMultiset
    public ImmutableSortedMultiset<E> tailMultiset(E e9, BoundType boundType) {
        return this.forward.headMultiset((ImmutableSortedMultiset<E>) e9, boundType).descendingMultiset();
    }
