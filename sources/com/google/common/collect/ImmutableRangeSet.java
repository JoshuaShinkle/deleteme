...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m17573of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m17574of(Range.all()));
    ...
    public final class AsSet extends ImmutableSortedSet<C> {
        ...
        @Override // com.google.common.collect.ImmutableSortedSet
        public ImmutableSortedSet<C> headSetImpl(C c9, boolean z8) {
            return subSet(Range.upTo(c9, BoundType.forBoolean(z8)));
        }
        ...
        @Override // com.google.common.collect.ImmutableSortedSet
        public ImmutableSortedSet<C> subSetImpl(C c9, boolean z8, C c10, boolean z9) {
            return (z8 || z9 || Range.compareOrThrow(c9, c10) != 0) ? subSet(Range.range(c9, BoundType.forBoolean(z8), c10, BoundType.forBoolean(z9))) : ImmutableSortedSet.m17653of();
        }

        @Override // com.google.common.collect.ImmutableSortedSet
        public ImmutableSortedSet<C> tailSetImpl(C c9, boolean z8) {
            return subSet(Range.downTo(c9, BoundType.forBoolean(z8)));
        }
    }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            return immutableListBuild.isEmpty() ? ImmutableRangeSet.m17613of() : (immutableListBuild.size() == 1 && ((Range) Iterables.getOnlyElement(immutableListBuild)).equals(Range.all())) ? ImmutableRangeSet.all() : new ImmutableRangeSet<>(immutableListBuild);
        }
    ...
    public final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        public Range<C> get(int i9) {
            ...
            return Range.create(this.positiveBoundedBelow ? i9 == 0 ? Cut.belowAll() : ((Range) ImmutableRangeSet.this.ranges.get(i9 - 1)).upperBound : ((Range) ImmutableRangeSet.this.ranges.get(i9)).upperBound, (this.positiveBoundedAbove && i9 == this.size + (-1)) ? Cut.aboveAll() : ((Range) ImmutableRangeSet.this.ranges.get(i9 + (!this.positiveBoundedBelow ? 1 : 0))).lowerBound);
        }
    }
    ...
    public static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            return this.ranges.isEmpty() ? ImmutableRangeSet.m17613of() : this.ranges.equals(ImmutableList.m17574of(Range.all())) ? ImmutableRangeSet.all() : new ImmutableRangeSet(this.ranges);
        }
    }
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return iBinarySearch2 == 0 ? ImmutableList.m17573of() : (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            @Override // com.google.common.collect.ImmutableCollection
            public boolean isPartialView() {
                return true;
            }
            ...
            @Override // java.util.List
            public Range<C> get(int i9) {
                Preconditions.checkElementIndex(i9, iBinarySearch2);
                return (i9 == 0 || i9 == iBinarySearch2 + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(i9 + iBinarySearch)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(i9 + iBinarySearch);
            }
        };
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m17613of() {
        return EMPTY;
    }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m17653of();
        }
    ...
    public Range<C> rangeContaining(C c9) {
        int iBinarySearch = SortedLists.binarySearch(this.ranges, Range.lowerBoundFn(), Cut.belowValue(c9), Ordering.natural(), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
        if (iBinarySearch == -1) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m17614of(Range<C> range) {
        Preconditions.checkNotNull(range);
        return range.isEmpty() ? m17613of() : range.equals(Range.all()) ? all() : new ImmutableRangeSet<>(ImmutableList.m17574of(range));
    }
    ...
    public ImmutableSet<Range<C>> asDescendingSetOfRanges() {
        return this.ranges.isEmpty() ? ImmutableSet.m17615of() : new RegularImmutableSortedSet(this.ranges.reverse(), Range.rangeLexOrdering().reverse());
    }

    @Override // com.google.common.collect.RangeSet
    public ImmutableSet<Range<C>> asRanges() {
        return this.ranges.isEmpty() ? ImmutableSet.m17615of() : new RegularImmutableSortedSet(this.ranges, Range.rangeLexOrdering());
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> immutableRangeSetM17613of = m17613of();
            this.complement = immutableRangeSetM17613of;
            return immutableRangeSetM17613of;
        }
