...
final class Synchronized {
    ...
    public static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V> {
        ...
        public V forcePut(K k9, V v8) {
            V vForcePut;
            synchronized (this.mutex) {
                vForcePut = delegate().forcePut(k9, v8);
            }
            return vForcePut;
        }
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public boolean addAll(int i9, Collection<? extends E> collection) {
            boolean zAddAll;
            synchronized (this.mutex) {
                zAddAll = delegate().addAll(i9, collection);
            }
            return zAddAll;
        }
        ...
        public List<E> subList(int i9, int i10) {
            List<E> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().subList(i9, i10), this.mutex);
            }
            return list;
        }
    ...
    public static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(K k9) {
            List<V> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().get((ListMultimap<K, V>) k9), this.mutex);
            }
            return list;
        }
        ...
        public List<V> replaceValues(K k9, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                listReplaceValues = delegate().replaceValues((ListMultimap<K, V>) k9, (Iterable) iterable);
            }
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        public Collection<V> get(K k9) {
            Collection<V> collectionTypePreservingCollection;
            synchronized (this.mutex) {
                collectionTypePreservingCollection = Synchronized.typePreservingCollection(delegate().get(k9), this.mutex);
            }
            return collectionTypePreservingCollection;
        }
        ...
        public boolean putAll(K k9, Iterable<? extends V> iterable) {
            boolean zPutAll;
            synchronized (this.mutex) {
                zPutAll = delegate().putAll(k9, iterable);
            }
            return zPutAll;
        }
        ...
        public Collection<V> replaceValues(K k9, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                collectionReplaceValues = delegate().replaceValues(k9, iterable);
            }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<V> get(K k9) {
            Set<V> set;
            synchronized (this.mutex) {
                set = Synchronized.set(delegate().get((SetMultimap<K, V>) k9), this.mutex);
            }
            return set;
        }
        ...
        public Set<V> replaceValues(K k9, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                setReplaceValues = delegate().replaceValues((SetMultimap<K, V>) k9, (Iterable) iterable);
            }
    ...
    public static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(K k9) {
            ...
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().get((SortedSetMultimap<K, V>) k9), this.mutex);
            }
            return sortedSet;
        }
        ...
        public SortedSet<V> replaceValues(K k9, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                sortedSetReplaceValues = delegate().replaceValues((SortedSetMultimap<K, V>) k9, (Iterable) iterable);
            }
    ...
    public static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        public Map<R, V> column(C c9) {
            Map<R, V> map;
            synchronized (this.mutex) {
                map = Synchronized.map(delegate().column(c9), this.mutex);
            }
            return map;
        }
    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public int remove(Object obj, int i9) {
            int iRemove;
            synchronized (this.mutex) {
                iRemove = delegate().remove(obj, i9);
            }
            return iRemove;
        }
        ...
        public boolean setCount(E e9, int i9, int i10) {
            boolean count;
            synchronized (this.mutex) {
                count = delegate().setCount(e9, i9, i10);
            }
            return count;
        }
    }
    ...
    public static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V> {
        ...
        public SortedMap<K, V> headMap(K k9) {
            ...
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().headMap(k9), this.mutex);
            }
            return sortedMap;
        }
        ...
        public SortedMap<K, V> subMap(K k9, K k10) {
            SortedMap<K, V> sortedMap;
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().subMap(k9, k10), this.mutex);
            }
            return sortedMap;
        }
        ...
        public SortedMap<K, V> tailMap(K k9) {
            SortedMap<K, V> sortedMap;
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().tailMap(k9), this.mutex);
            }
            return sortedMap;
        }
    ...
    public static final class SynchronizedDeque<E> extends SynchronizedQueue<E> implements Deque<E> {
        ...
        public boolean offerFirst(E e9) {
            boolean zOfferFirst;
            synchronized (this.mutex) {
                zOfferFirst = delegate().offerFirst(e9);
            }
            return zOfferFirst;
        }
        ...
        public boolean offerLast(E e9) {
            boolean zOfferLast;
            synchronized (this.mutex) {
                zOfferLast = delegate().offerLast(e9);
            }
            return zOfferLast;
        }
    ...
    public static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(K k9) {
            ...
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().ceilingEntry(k9), this.mutex);
            }
        ...
        public K ceilingKey(K k9) {
            K kCeilingKey;
            synchronized (this.mutex) {
                kCeilingKey = delegate().ceilingKey(k9);
            }
            return kCeilingKey;
        }
        ...
        public Map.Entry<K, V> floorEntry(K k9) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().floorEntry(k9), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K floorKey(K k9) {
            K kFloorKey;
            synchronized (this.mutex) {
                kFloorKey = delegate().floorKey(k9);
            }
            return kFloorKey;
        }
        ...
        public NavigableMap<K, V> headMap(K k9, boolean z8) {
            ...
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().headMap(k9, z8), this.mutex);
            }
            return navigableMap;
        }
        ...
        public Map.Entry<K, V> higherEntry(K k9) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().higherEntry(k9), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K higherKey(K k9) {
            K kHigherKey;
            synchronized (this.mutex) {
                kHigherKey = delegate().higherKey(k9);
            }
            return kHigherKey;
        }
        ...
        public Map.Entry<K, V> lowerEntry(K k9) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().lowerEntry(k9), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K lowerKey(K k9) {
            K kLowerKey;
            synchronized (this.mutex) {
                kLowerKey = delegate().lowerKey(k9);
            }
            return kLowerKey;
        }
        ...
        public NavigableMap<K, V> subMap(K k9, boolean z8, K k10, boolean z9) {
            NavigableMap<K, V> navigableMap;
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().subMap(k9, z8, k10, z9), this.mutex);
            }
            return navigableMap;
        }
        ...
        public NavigableMap<K, V> tailMap(K k9, boolean z8) {
            NavigableMap<K, V> navigableMap;
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().tailMap(k9, z8), this.mutex);
            }
            return navigableMap;
        }
    ...
    public static class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E> {
        ...
        public NavigableSet<E> headSet(E e9, boolean z8) {
            ...
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().headSet(e9, z8), this.mutex);
            }
            return navigableSet;
        }
        ...
        public NavigableSet<E> subSet(E e9, boolean z8, E e10, boolean z9) {
            NavigableSet<E> navigableSet;
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().subSet(e9, z8, e10, z9), this.mutex);
            }
            return navigableSet;
        }
        ...
        public NavigableSet<E> tailSet(E e9, boolean z8) {
            NavigableSet<E> navigableSet;
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().tailSet(e9, z8), this.mutex);
            }
            return navigableSet;
        }
    ...
    public static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E> {
        ...
        public SortedSet<E> headSet(E e9) {
            ...
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().headSet(e9), this.mutex);
            }
            return sortedSet;
        }
        ...
        public SortedSet<E> subSet(E e9, E e10) {
            SortedSet<E> sortedSet;
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().subSet(e9, e10), this.mutex);
            }
            return sortedSet;
        }
        ...
        public SortedSet<E> tailSet(E e9) {
            SortedSet<E> sortedSet;
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().tailSet(e9), this.mutex);
            }
            return sortedSet;
        }
