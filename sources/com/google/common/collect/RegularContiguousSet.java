...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    public ImmutableList<C> createAsList() {
        return this.domain.supportsFastOffset ? new ImmutableAsList<C>() { // from class: com.google.common.collect.RegularContiguousSet.3
            ...
            public C get(int i9) {
                ...
                return (C) regularContiguousSet.domain.offset(regularContiguousSet.first(), i9);
            }
        } : super.createAsList();
    }
    ...
    public UnmodifiableIterator<C> descendingIterator() {
        return new AbstractSequentialIterator<C>(last()) { // from class: com.google.common.collect.RegularContiguousSet.2
            ...
            public C computeNext(C c9) {
                if (RegularContiguousSet.equalsOrThrow(c9, this.first)) {
                    return null;
                }
                return (C) RegularContiguousSet.this.domain.previous(c9);
            }
        };
    }
    ...
    public ContiguousSet<C> headSetImpl(C c9, boolean z8) {
        return intersectionInCurrentDomain(Range.upTo(c9, BoundType.forBoolean(z8)));
    }
    ...
    public UnmodifiableIterator<C> iterator() {
        return new AbstractSequentialIterator<C>(first()) { // from class: com.google.common.collect.RegularContiguousSet.1
            ...
            @Override // com.google.common.collect.AbstractSequentialIterator
            public C computeNext(C c9) {
                if (RegularContiguousSet.equalsOrThrow(c9, this.last)) {
                    return null;
                }
                return (C) RegularContiguousSet.this.domain.next(c9);
            }
        };
    }
    ...
    public ContiguousSet<C> subSetImpl(C c9, boolean z8, C c10, boolean z9) {
        return (c9.compareTo(c10) != 0 || z8 || z9) ? intersectionInCurrentDomain(Range.range(c9, BoundType.forBoolean(z8), c10, BoundType.forBoolean(z9))) : new EmptyContiguousSet(this.domain);
    }

    @Override // com.google.common.collect.ContiguousSet, com.google.common.collect.ImmutableSortedSet
    public ContiguousSet<C> tailSetImpl(C c9, boolean z8) {
        return intersectionInCurrentDomain(Range.downTo(c9, BoundType.forBoolean(z8)));
    }
}
