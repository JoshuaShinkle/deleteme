...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static final class Builder<R, C, V> {
        ...
        public ImmutableTable<R, C, V> build() {
            ...
            return size != 0 ? size != 1 ? RegularImmutableTable.forCells(this.cells, this.rowComparator, this.columnComparator) : new SingletonImmutableTable((Table.Cell) Iterables.getOnlyElement(this.cells)) : ImmutableTable.m17666of();
        }
        ...
        @CanIgnoreReturnValue
        public Builder<R, C, V> put(R r8, C c9, V v8) {
            this.cells.add(ImmutableTable.cellOf(r8, c9, v8));
            return this;
        }
    ...
    public static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (objArr.length == 0) {
                return ImmutableTable.m17666of();
            }
            int i9 = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m17667of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
            ...
            while (true) {
                ...
                builder.add((ImmutableList.Builder) ImmutableTable.cellOf(this.rowKeys[this.cellRowIndices[i9]], this.columnKeys[this.cellColumnIndices[i9]], objArr2[i9]));
                i9++;
            }
        }
    }
    ...
    public static <R, C, V> Table.Cell<R, C, V> cellOf(R r8, C c9, V v8) {
        return Tables.immutableCell(Preconditions.checkNotNull(r8), Preconditions.checkNotNull(c9), Preconditions.checkNotNull(v8));
    }
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m17666of() {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m17667of(R r8, C c9, V v8) {
    ...
    public ImmutableMap<R, V> column(C c9) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c9), ImmutableMap.m17592of());
    }
    ...
    public ImmutableMap<C, V> row(R r8) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r8), ImmutableMap.m17592of());
    }
