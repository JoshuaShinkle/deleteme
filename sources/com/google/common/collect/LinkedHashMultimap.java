...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        public ValueEntry(K k9, V v8, int i9, ValueEntry<K, V> valueEntry) {
            super(k9, v8);
            this.smearedValueHash = i9;
        ...
        public boolean matchesValue(Object obj, int i9) {
            return this.smearedValueHash == i9 && Objects.equal(getValue(), obj);
        }
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public ValueSet(K k9, int i9) {
            this.key = k9;
            this.hashTable = new ValueEntry[Hashing.closedTableSize(i9, LinkedHashMultimap.VALUE_SET_LOAD_FACTOR)];
        }
        ...
        private void rehashIfNecessary() {
            if (Hashing.needsResizing(this.size, this.hashTable.length, LinkedHashMultimap.VALUE_SET_LOAD_FACTOR)) {
                ...
                for (ValueSetLink<K, V> successorInValueSet = this.firstEntry; successorInValueSet != this; successorInValueSet = successorInValueSet.getSuccessorInValueSet()) {
                    ...
                    int i10 = valueEntry.smearedValueHash & i9;
                    valueEntry.nextInValueBucket = valueEntryArr[i10];
        ...
        public boolean add(V v8) {
            ...
            for (ValueEntry<K, V> valueEntry2 = valueEntry; valueEntry2 != null; valueEntry2 = valueEntry2.nextInValueBucket) {
                if (valueEntry2.matchesValue(v8, iSmearedHash)) {
                    return false;
                }
            }
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v8, iSmearedHash, valueEntry);
    ...
    public Collection<V> createCollection(K k9) {
        return new ValueSet(k9, this.valueSetCapacity);
    }
