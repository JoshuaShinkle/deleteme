...
public final class Tables {
    ...
    public static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        public ImmutableCell(R r8, C c9, V v8) {
            this.rowKey = r8;
            this.columnKey = c9;
            this.value = v8;
        }
    ...
    public static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        public Map<R, V2> column(C c9) {
            return Maps.transformValues(this.fromTable.column(c9), this.function);
        }
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        public V2 put(R r8, C c9, V2 v22) {
    ...
    public static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        public V put(C c9, R r8, V v8) {
            return this.original.put(r8, c9, v8);
        }
        ...
        @Override // com.google.common.collect.Table
        public Map<R, V> row(C c9) {
            return this.original.column(c9);
        }
    ...
    public static <R, C, V> Table.Cell<R, C, V> immutableCell(R r8, C c9, V v8) {
