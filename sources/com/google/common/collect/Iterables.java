...
public final class Iterables {
    ...
    public static <T> T get(Iterable<T> iterable, int i9) {
        Preconditions.checkNotNull(iterable);
        return iterable instanceof List ? (T) ((List) iterable).get(i9) : (T) Iterators.get(iterable.iterator(), i9);
    }

    public static <T> T getFirst(Iterable<? extends T> iterable, T t8) {
        return (T) Iterators.getNext(iterable.iterator(), t8);
    }
    ...
    public static <T> Iterable<T> limit(final Iterable<T> iterable, final int i9) {
        Preconditions.checkNotNull(iterable);
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.7
            @Override // java.lang.Iterable
            public Iterator<T> iterator() {
                return Iterators.limit(iterable.iterator(), i9);
            }
        };
    }
    ...
    public static <T> Iterable<List<T>> paddedPartition(final Iterable<T> iterable, final int i9) {
        Preconditions.checkNotNull(iterable);
        Preconditions.checkArgument(i9 > 0);
        return new FluentIterable<List<T>>() { // from class: com.google.common.collect.Iterables.3
            @Override // java.lang.Iterable
            public Iterator<List<T>> iterator() {
                return Iterators.paddedPartition(iterable.iterator(), i9);
            }
        };
    }

    public static <T> Iterable<List<T>> partition(final Iterable<T> iterable, final int i9) {
        Preconditions.checkNotNull(iterable);
        Preconditions.checkArgument(i9 > 0);
        return new FluentIterable<List<T>>() { // from class: com.google.common.collect.Iterables.2
            @Override // java.lang.Iterable
            public Iterator<List<T>> iterator() {
                return Iterators.partition(iterable.iterator(), i9);
            }
        };
    }
            ...
            if (!predicate.apply(t8)) {
                if (i9 > i10) {
                    try {
                        ...
                        slowRemoveIfForRemainingElements(list, predicate, i10, i9);
                        return true;
    ...
    public static <T> Iterable<T> skip(final Iterable<T> iterable, final int i9) {
        Preconditions.checkNotNull(iterable);
        Preconditions.checkArgument(i9 >= 0, "number to skip cannot be negative");
    ...
    private static <T> void slowRemoveIfForRemainingElements(List<T> list, Predicate<? super T> predicate, int i9, int i10) {
    ...
    public static <T> T find(Iterable<? extends T> iterable, Predicate<? super T> predicate, T t8) {
        return (T) Iterators.find(iterable.iterator(), predicate, t8);
    }

    public static <T> T getOnlyElement(Iterable<? extends T> iterable, T t8) {
        return (T) Iterators.getOnlyElement(iterable.iterator(), t8);
    }
    ...
    public static <T> T get(Iterable<? extends T> iterable, int i9, T t8) {
        Preconditions.checkNotNull(iterable);
        Iterators.checkNonnegative(i9);
        if (iterable instanceof List) {
            List listCast = Lists.cast(iterable);
            return i9 < listCast.size() ? (T) listCast.get(i9) : t8;
        }
        Iterator<? extends T> it = iterable.iterator();
        Iterators.advance(it, i9);
        return (T) Iterators.getNext(it, t8);
    }
    ...
    public static <T> T getLast(Iterable<? extends T> iterable, T t8) {
        ...
        return (T) Iterators.getLast(iterable.iterator(), t8);
    }
}
