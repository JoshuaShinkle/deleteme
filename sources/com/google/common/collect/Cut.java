...
abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    public static /* synthetic */ class C36421 {
    ...
    public static final class AboveValue<C extends Comparable> extends Cut<C> {
        ...
        public AboveValue(C c9) {
            super((Comparable) Preconditions.checkNotNull(c9));
        }
        ...
        public Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i9 = C36421.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
            if (i9 == 1) {
    ...
    public static <C extends Comparable> Cut<C> aboveValue(C c9) {
        return new AboveValue(c9);
    }
    ...
    public static <C extends Comparable> Cut<C> belowValue(C c9) {
        return new BelowValue(c9);
    }
