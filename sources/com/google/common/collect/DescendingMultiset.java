...
abstract class DescendingMultiset<E> extends ForwardingMultiset<E> implements SortedMultiset<E> {
    ...
    public SortedMultiset<E> headMultiset(E e9, BoundType boundType) {
        return forwardMultiset().tailMultiset(e9, boundType).descendingMultiset();
    }
    ...
    public SortedMultiset<E> subMultiset(E e9, BoundType boundType, E e10, BoundType boundType2) {
        return forwardMultiset().subMultiset(e10, boundType2, e9, boundType).descendingMultiset();
    }

    @Override // com.google.common.collect.SortedMultiset
    public SortedMultiset<E> tailMultiset(E e9, BoundType boundType) {
        return forwardMultiset().headMultiset(e9, boundType).descendingMultiset();
    }
