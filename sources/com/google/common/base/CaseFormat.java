...
public abstract class CaseFormat {
    ...
    public static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doBackward(String str) {
            return this.targetFormat.m17546to(this.sourceFormat, str);
        }

        @Override // com.google.common.base.Converter
        public String doForward(String str) {
            return this.sourceFormat.m17546to(this.targetFormat, str);
        }
    }

    static {
        CaseFormat caseFormat = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.m17547is('-'), "-") { // from class: com.google.common.base.CaseFormat.1
        ...
        String str = "_";
        CaseFormat caseFormat2 = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.m17547is('_'), str) { // from class: com.google.common.base.CaseFormat.2
            @Override // com.google.common.base.CaseFormat
        ...
        CaseFormat caseFormat5 = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.m17547is('_'), str) { // from class: com.google.common.base.CaseFormat.5
            @Override // com.google.common.base.CaseFormat
    ...
    /* renamed from: to */
    public final String m17546to(CaseFormat caseFormat, String str) {
        Preconditions.checkNotNull(caseFormat);
        Preconditions.checkNotNull(str);
        return caseFormat == this ? str : convert(caseFormat, str);
    }

    private CaseFormat(String str, int i9, CharMatcher charMatcher, String str2) {
