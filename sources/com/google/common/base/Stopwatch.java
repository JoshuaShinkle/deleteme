...
public final class Stopwatch {
    ...
    public static /* synthetic */ class C35831 {
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C35831.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
    ...
    private static TimeUnit chooseUnit(long j9) {
    ...
    public Stopwatch stop() {
        ...
        this.isRunning = false;
        this.elapsedNanos += j9 - this.startTick;
        return this;
    }
