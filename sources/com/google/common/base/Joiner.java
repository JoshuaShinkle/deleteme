...
public class Joiner {
    ...
    public static final class MapJoiner {
        ...
        public <A extends Appendable> A appendTo(A a9, Map<?, ?> map) {
            return (A) appendTo((MapJoiner) a9, (Iterable<? extends Map.Entry<?, ?>>) map.entrySet());
        }
        ...
        public <A extends Appendable> A appendTo(A a9, Iterable<? extends Map.Entry<?, ?>> iterable) {
            return (A) appendTo((MapJoiner) a9, iterable.iterator());
        }
        ...
        public <A extends Appendable> A appendTo(A a9, Iterator<? extends Map.Entry<?, ?>> it) throws IOException {
            ...
            if (it.hasNext()) {
                ...
                while (it.hasNext()) {
                    a9.append(this.joiner.separator);
    ...
    private static Iterable<Object> iterable(final Object obj, final Object obj2, final Object[] objArr) {
        ...
        return new AbstractList<Object>() { // from class: com.google.common.base.Joiner.3
            ...
            public Object get(int i9) {
                return i9 != 0 ? i9 != 1 ? objArr[i9 - 2] : obj2 : obj;
            }
    ...
    /* renamed from: on */
    public static Joiner m17550on(String str) {
        return new Joiner(str);
    }

    @CanIgnoreReturnValue
    public <A extends Appendable> A appendTo(A a9, Iterable<?> iterable) {
        return (A) appendTo((Joiner) a9, iterable.iterator());
    }
    ...
    public Joiner skipNulls() {
        return new Joiner(this) { // from class: com.google.common.base.Joiner.2
            ...
            public <A extends Appendable> A appendTo(A a9, Iterator<?> it) throws IOException {
                Preconditions.checkNotNull(a9, "appendable");
                ...
                while (true) {
                    ...
                    Object next = it.next();
                    if (next != null) {
                        a9.append(Joiner.this.toString(next));
                        break;
                    }
                }
                while (it.hasNext()) {
                    ...
                    if (next2 != null) {
                        a9.append(Joiner.this.separator);
                        a9.append(Joiner.this.toString(next2));
                    }
                }
                return a9;
            }
    ...
    public MapJoiner withKeyValueSeparator(char c9) {
    ...
    /* renamed from: on */
    public static Joiner m17549on(char c9) {
    ...
    public <A extends Appendable> A appendTo(A a9, Iterator<?> it) throws IOException {
        Preconditions.checkNotNull(a9);
        if (it.hasNext()) {
            a9.append(toString(it.next()));
            while (it.hasNext()) {
                a9.append(this.separator);
                a9.append(toString(it.next()));
            }
        }
        return a9;
    ...
    public final <A extends Appendable> A appendTo(A a9, Object[] objArr) {
        return (A) appendTo((Joiner) a9, (Iterable<?>) Arrays.asList(objArr));
    }

    @CanIgnoreReturnValue
    public final <A extends Appendable> A appendTo(A a9, Object obj, Object obj2, Object... objArr) {
        return (A) appendTo((Joiner) a9, iterable(obj, obj2, objArr));
    }
