...
public class FinalizableReferenceQueue implements Closeable {
    ...
    public static class DecoupledLoader implements FinalizerLoader {
        ...
        public URL getBaseUrl() throws IOException {
            String str = FinalizableReferenceQueue.FINALIZER_CLASS_NAME.replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, IOUtils.DIR_SEPARATOR_UNIX) + ".class";
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                FinalizableReferenceQueue.logger.log(Level.WARNING, LOADING_ERROR, (Throwable) e9);
                return null;
            }
        }
