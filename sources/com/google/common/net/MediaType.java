...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m17587of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m17550on("; ").withKeyValueSeparator("=");
    ...
    public static MediaType create(String str, String str2) {
        MediaType mediaTypeCreate = create(str, str2, ImmutableListMultimap.m17586of());
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType mediaTypeAddKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m17586of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        mediaTypeAddKnownType.parsedCharset = Optional.m17551of(Charsets.UTF_8);
        return mediaTypeAddKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optionalAbsent = Optional.m17551of(Charset.forName(next));
                    str = next;
    ...
    /* renamed from: is */
    public boolean m17683is(MediaType mediaType) {
    ...
    public MediaType withCharset(Charset charset) {
        ...
        mediaTypeWithParameter.parsedCharset = Optional.m17551of(charset);
    ...
    public MediaType withParameter(String str, String str2) {
        ...
        builder.put((ImmutableListMultimap.Builder) strNormalizeToken, normalizeParameterValue(strNormalizeToken, str2));
    ...
    public static final class Tokenizer {
        ...
        public String consumeToken(CharMatcher charMatcher) {
            ...
            Preconditions.checkState(this.position != i9);
        ...
        public String consumeTokenIfPresent(CharMatcher charMatcher) {
            Preconditions.checkState(hasMore());
            int i9 = this.position;
            this.position = charMatcher.negate().indexIn(this.input, i9);
            return hasMore() ? this.input.substring(i9, this.position) : this.input.substring(i9);
        }

        public boolean hasMore() {
            int i9 = this.position;
            return i9 >= 0 && i9 < this.input.length();
        }
        ...
        public char consumeCharacter(char c9) {
            Preconditions.checkState(hasMore());
            Preconditions.checkState(previewChar() == c9);
            this.position++;
            return c9;
        }
    }
