...
class SnackbarManager {
    ...
    public static class SnackbarRecord {
        ...
        public SnackbarRecord(int i9, Callback callback) {
    ...
    private boolean cancelSnackbarLocked(SnackbarRecord snackbarRecord, int i9) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord snackbarRecord) {
        int i9 = snackbarRecord.duration;
        if (i9 == -2) {
            return;
        }
        if (i9 <= 0) {
    ...
    public void dismiss(Callback callback, int i9) {
        synchronized (this.lock) {
            if (isCurrentSnackbarLocked(callback)) {
                cancelSnackbarLocked(this.currentSnackbar, i9);
            } else if (isNextSnackbarLocked(callback)) {
                cancelSnackbarLocked(this.nextSnackbar, i9);
            }
        }
    }
    ...
    public boolean isCurrentOrNext(Callback callback) {
        boolean z8;
        synchronized (this.lock) {
            z8 = isCurrentSnackbarLocked(callback) || isNextSnackbarLocked(callback);
        }
        return z8;
    }
    ...
    public void show(int i9, Callback callback) {
        synchronized (this.lock) {
            if (isCurrentSnackbarLocked(callback)) {
                SnackbarRecord snackbarRecord = this.currentSnackbar;
                snackbarRecord.duration = i9;
                this.handler.removeCallbacksAndMessages(snackbarRecord);
                scheduleTimeoutLocked(this.currentSnackbar);
                return;
            }
            if (isNextSnackbarLocked(callback)) {
                ...
                this.nextSnackbar = new SnackbarRecord(i9, callback);
            }
