...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C3476R.attr.snackbarButtonStyle};
    ...
    public Snackbar setAction(int i9, View.OnClickListener onClickListener) {
        return setAction(getContext().getText(i9), onClickListener);
    }
    ...
    public Snackbar setActionTextColor(int i9) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getActionView().setTextColor(i9);
        return this;
    }

    public Snackbar setText(int i9) {
        return setText(getContext().getText(i9));
    }

    public static Snackbar make(View view, int i9, int i10) {
        return make(view, view.getResources().getText(i9), i10);
    }
}
