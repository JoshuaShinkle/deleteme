...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(View view, boolean z8, boolean z9, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        MotionTiming motionTiming = z8 ? this.expandTiming : this.collapseTiming;
        if (z8) {
            if (!z9) {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, final View view2, final boolean z8, boolean z9) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z8, z9, arrayList, new ArrayList());
