...
final class CctTransportBackend implements TransportBackend {
    ...
    public static final class HttpResponse {
        ...
        public HttpResponse(int i9, URL url, long j9) {
            this.code = i9;
            this.redirectUrl = url;
            this.nextRequestMillis = j9;
        }
    }

    public CctTransportBackend(Context context, Clock clock, Clock clock2, int i9) {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m17459i(LOG_TAG, "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m17459i(LOG_TAG, "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m17455d(LOG_TAG, "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                    Logging.m17455d(LOG_TAG, "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e9;
            Logging.m17458e(LOG_TAG, "Couldn't encode request, returning with 400", e);
            return new HttpResponse(400, null, 0L);
        } catch (ConnectException e10) {
            e = e10;
            Logging.m17458e(LOG_TAG, "Couldn't open connection, returning with 500", e);
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m17458e(LOG_TAG, "Unable to find version code for package", e9);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m17449of("proto"))) {
                    builderProtoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m17449of("json"))) {
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m17460w(LOG_TAG, "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public static /* synthetic */ HttpRequest lambda$send$0(HttpRequest httpRequest, HttpResponse httpResponse) {
        ...
        Logging.m17455d(LOG_TAG, "Following redirect to: %s", url);
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new Function() { // from class: com.google.android.datatransport.cct.a
                ...
                public final Object apply(Object obj) {
                    return this.f15231a.doSend((CctTransportBackend.HttpRequest) obj);
                }
            ...
            int i9 = httpResponse.code;
            if (i9 == 200) {
                return BackendResponse.m17453ok(httpResponse.nextRequestMillis);
            }
            if (i9 < 500 && i9 != 404) {
                return i9 == 400 ? BackendResponse.invalidPayload() : BackendResponse.fatalError();
            }
            return BackendResponse.transientError();
        } catch (IOException e9) {
            Logging.m17458e(LOG_TAG, "Could not make request to the backend", e9);
            return BackendResponse.transientError();
        }
    }
