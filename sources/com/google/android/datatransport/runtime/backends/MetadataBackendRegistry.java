    ...
    public static class BackendFactoryProvider {
        ...
        public BackendFactory get(String str) {
            ...
            try {
                ...
                Log.w(MetadataBackendRegistry.TAG, String.format("Class %s is not found.", str2), e9);
                return null;
            } catch (IllegalAccessException e10) {
                Log.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s.", str2), e10);
                return null;
            } catch (InstantiationException e11) {
                Log.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s.", str2), e11);
                return null;
            } catch (NoSuchMethodException e12) {
                Log.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s", str2), e12);
                return null;
            } catch (InvocationTargetException e13) {
                Log.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s", str2), e13);
                return null;
            }
        }
    }
