...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int iIntValue = Integer.valueOf(intent.getData().getQueryParameter(Constants.FirelogAnalytics.PARAM_PRIORITY)).intValue();
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i9, new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.a
