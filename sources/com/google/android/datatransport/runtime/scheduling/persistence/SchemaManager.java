...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    public SchemaManager(Context context, String str, int i9) {
    ...
    private void upgrade(SQLiteDatabase sQLiteDatabase, int i9, int i10) {
        ...
        if (i10 <= list.size()) {
            while (i9 < i10) {
                INCREMENTAL_MIGRATIONS.get(i9).upgrade(sQLiteDatabase);
                i9++;
            }
            return;
        }
    ...
    @Override // android.database.sqlite.SQLiteOpenHelper
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i9, int i10) throws SQLException {
    ...
    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i9, int i10) {
        ensureConfigured(sQLiteDatabase);
        upgrade(sQLiteDatabase, i9, i10);
    }

    private void onCreate(SQLiteDatabase sQLiteDatabase, int i9) {
        ensureConfigured(sQLiteDatabase);
        upgrade(sQLiteDatabase, 0, i9);
    }
}
