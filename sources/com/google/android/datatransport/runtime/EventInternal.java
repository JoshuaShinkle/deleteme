...
public abstract class EventInternal {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setEventMillis(long j9);

        public abstract Builder setTransportName(String str);

        public abstract Builder setUptimeMillis(long j9);

        public final Builder addMetadata(String str, long j9) {
            getAutoMetadata().put(str, String.valueOf(j9));
            return this;
        }

        public final Builder addMetadata(String str, int i9) {
            getAutoMetadata().put(str, String.valueOf(i9));
            return this;
        }
    }
