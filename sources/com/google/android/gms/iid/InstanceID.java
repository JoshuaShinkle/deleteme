...
public class InstanceID {
    ...
    private static Map<String, InstanceID> zzbv = new C5302a();
    ...
    public static String zzd(KeyPair keyPair) {
        try {
            ...
            bArrDigest[0] = (byte) ((bArrDigest[0] & Ascii.f15389SI) + 112);
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        ...
        String strZzf = !z8 ? zzbx.zzf(this.zzca, str, str2) : null;
        if (strZzf != null) {
            return strZzf;
        }
        if (bundle == null) {
