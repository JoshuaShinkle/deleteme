...
public final class Tasks {
    ...
    public static <T> Task<T> withTimeout(Task<T> task, long j9, TimeUnit timeUnit) {
        Preconditions.checkNotNull(task, "Task must not be null");
        Preconditions.checkArgument(j9 > 0, "Timeout must be positive");
    ...
    public static <TResult> TResult await(Task<TResult> task, long j9, TimeUnit timeUnit) throws TimeoutException {
        Preconditions.checkNotMainThread();
        Preconditions.checkNotNull(task, "Task must not be null");
        Preconditions.checkNotNull(timeUnit, "TimeUnit must not be null");
        if (task.isComplete()) {
