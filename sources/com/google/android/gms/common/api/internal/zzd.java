...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new C5302a());
    private int zzc = 0;
    private Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzdVar2 = (zzd) fragmentActivity.getSupportFragmentManager().mo1848e("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                fragmentActivity.getSupportFragmentManager().mo1844a().m1982d(zzdVar2, "SupportLifecycleFragmentImpl").mo1794h();
            }
