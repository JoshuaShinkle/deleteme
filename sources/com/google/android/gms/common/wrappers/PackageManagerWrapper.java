...
public class PackageManagerWrapper {
    ...
    @KeepForSdk
    public C0698d<CharSequence, Drawable> getApplicationLabelAndIcon(String str) throws PackageManager.NameNotFoundException {
        ApplicationInfo applicationInfo = this.zza.getPackageManager().getApplicationInfo(str, 0);
        return C0698d.m3463a(this.zza.getPackageManager().getApplicationLabel(applicationInfo), this.zza.getPackageManager().getApplicationIcon(applicationInfo));
    }
    ...
    @TargetApi(19)
    public final boolean zza(int i9, String str) {
