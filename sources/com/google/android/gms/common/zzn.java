...
final class zzn {
    ...
    public static /* synthetic */ String zzd(boolean z8, String str, zzj zzjVar) throws NoSuchAlgorithmException {
        String str2 = true != (!z8 && zzh(str, zzjVar, true, false).zza) ? "not allowed" : "debug cert rejected";
        MessageDigest messageDigestZza = AndroidUtilsLight.zza("SHA-256");
        Preconditions.checkNotNull(messageDigestZza);
        return String.format("%s: pkg=%s, sha256=%s, atk=%s, ver=%s", str2, str, Hex.bytesToStringLowercase(messageDigestZza.digest(zzjVar.zzf())), Boolean.valueOf(z8), "12451000.false");
    }
    ...
    private static zzx zzh(final String str, final zzj zzjVar, final boolean z8, boolean z9) {
        try {
            ...
            try {
                return zze.zzh(new zzs(str, zzjVar, z8, z9), ObjectWrapper.wrap(zzg.getPackageManager())) ? zzx.zzb() : new zzv(new Callable() { // from class: com.google.android.gms.common.zze
                ...
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e9);
                return zzx.zzd("module call", e9);
            }
        } catch (DynamiteModule.LoadingException e10) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e10);
            return zzx.zzd("module init: ".concat(String.valueOf(e10.getMessage())), e10);
        }
    }
    ...
    private static zzx zzi(String str, boolean z8, boolean z9, boolean z10, boolean z11) {
        ...
        try {
            ...
            try {
                zzj();
                zzo zzoVar = new zzo(str, z8, false, ObjectWrapper.wrap(zzg), false);
                try {
                    zzq zzqVarZze = z11 ? zze.zze(zzoVar) : zze.zzf(zzoVar);
                    if (zzqVarZze.zzb()) {
                    ...
                    Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e9);
                    zzxVarZzd = zzx.zzd("module call", e9);
                }
            } catch (DynamiteModule.LoadingException e10) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e10);
                zzxVarZzd = zzx.zzd("module init: ".concat(String.valueOf(e10.getMessage())), e10);
            }
            return zzxVarZzd;
        } finally {
            StrictMode.setThreadPolicy(threadPolicyAllowThreadDiskReads);
