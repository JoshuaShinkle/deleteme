...
public final class UidVerifier {
    ...
    @KeepForSdk
    public static boolean isGooglePlayServicesUid(Context context, int i9) throws PackageManager.NameNotFoundException {
        if (!uidHasPackageName(context, i9, "com.google.android.gms")) {
            return false;
        }
        try {
    ...
    public static boolean uidHasPackageName(Context context, int i9, String str) {
        return Wrappers.packageManager(context).zza(i9, str);
    }
}
