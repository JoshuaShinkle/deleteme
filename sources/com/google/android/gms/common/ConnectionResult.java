...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m17520id = 2)
    private final int zzb;

    @SafeParcelable.Field(getter = "getResolution", m17520id = 3)
    private final PendingIntent zzc;

    @SafeParcelable.Field(getter = "getErrorMessage", m17520id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m17521id = 1) int i9, @SafeParcelable.Param(m17521id = 2) int i10, @SafeParcelable.Param(m17521id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m17521id = 4) String str) {
        this.zza = i9;
        this.zzb = i10;
    ...
    public void writeToParcel(Parcel parcel, int i9) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, getResolution(), i9, false);
