...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i9, boolean z8, Executor executor) {
        ...
        try {
            boolean zZze = zze(context, intent, serviceConnection, i9, executor);
            if (zZze) {
                return zZze;
            }
            return false;
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i9, Executor executor) {
        return (!PlatformVersion.isAtLeastQ() || executor == null) ? context.bindService(intent, serviceConnection, i9) : context.bindService(intent, i9, executor, serviceConnection);
    }
    ...
    public final boolean zza(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i9, Executor executor) {
        return zzc(context, str, intent, serviceConnection, i9, true, executor);
    }
}
