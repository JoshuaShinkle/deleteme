...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Intent getIntent() {
            ...
            Preconditions.checkState((z9 && booleanExtra) ? false : true, "Call-to-action buttons are only available for URLs.");
            ...
            Preconditions.checkState(z8, "Must set content URL or content deep-link ID to use a call-to-action button.");
