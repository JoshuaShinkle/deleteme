...
final class zzes extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        try {
            ...
            try {
                ...
                this.zza.zzq().zze().zza("Failed to open local database. Events will bypass local storage", e10);
                return null;
            }
        }
    }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws SQLException {
        zzag.zza(this.zza.zzq(), sQLiteDatabase, "messages", "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", null);
    }
