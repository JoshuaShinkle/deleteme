...
public class WorkAccountClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    public Task<Void> setWorkAuthenticatorEnabled(boolean z8) {
        return PendingResultUtil.toVoidTask(this.zzac.setWorkAuthenticatorEnabledWithResult(asGoogleApiClient(), z8));
    }
