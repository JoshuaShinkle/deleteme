...
public class zzd {
    ...
    private static void ensurePlayServicesAvailable(Context context, int i9) throws GoogleAuthException {
        try {
            GooglePlayServicesUtilLight.ensurePlayServicesAvailable(context.getApplicationContext(), i9);
        } catch (GooglePlayServicesNotAvailableException e9) {
            throw new GoogleAuthException(e9.getMessage());
        } catch (GooglePlayServicesRepairableException e10) {
            throw new GooglePlayServicesAvailabilityException(e10.getConnectionStatusCode(), e10.getMessage(), e10.getIntent());
        }
    }

    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int i9, String str) throws GoogleAuthException {
        Preconditions.checkNotEmpty(str, "accountName must be provided");
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        ensurePlayServicesAvailable(context, 8400000);
        return (List) zza(context, zzm, new zzg(str, i9));
    }
    ...
    public static <T> T zza(T t8) throws IOException {
        if (t8 != null) {
            return t8;
        }
        zzn.m17530w("GoogleAuthUtil", "Binder call returned null.");
        ...
        try {
            if (gmsClientSupervisor.bindService(componentName, blockingServiceConnection, "GoogleAuthUtil")) {
                try {
                    ...
                    zzn.m17527i("GoogleAuthUtil", "Error on service connection.", e9);
