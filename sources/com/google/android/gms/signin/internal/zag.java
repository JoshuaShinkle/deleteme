...
public final class zag extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getGrantedScopes", m17520id = 1)
    ...
    public zag(@SafeParcelable.Param(m17521id = 1) List<String> list, @SafeParcelable.Param(m17521id = 2) String str) {
        this.zaa = list;
        this.zab = str;
    }
