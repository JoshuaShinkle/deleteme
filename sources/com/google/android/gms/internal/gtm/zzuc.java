        ...
        while (i9 < i11) {
            ...
            if (zzua.zzd(b10)) {
                ...
                while (i14 < i11) {
                    ...
                    i14++;
                    zzua.zza(b11, cArr, i15);
                    i15++;
                }
                i9 = i14;
                i13 = i15;
            } else if (zzua.zze(b10)) {
                if (i14 >= i11) {
                    throw zzrk.zzpw();
                }
                zzua.zza(b10, bArr[i14], cArr, i13);
                i9 = i14 + 1;
                i13++;
            } else if (zzua.zzf(b10)) {
                if (i14 >= i11 - 1) {
                    throw zzrk.zzpw();
                }
                int i16 = i14 + 1;
                zzua.zza(b10, bArr[i14], bArr[i16], cArr, i13);
                i9 = i16 + 1;
                i13++;
            } else {
                if (i14 >= i11 - 2) {
                ...
                byte b12 = bArr[i14];
                int i18 = i17 + 1;
                zzua.zza(b10, b12, bArr[i17], bArr[i18], cArr, i13);
                i9 = i18 + 1;
                i13 = i13 + 1 + 1;
            }
        }
