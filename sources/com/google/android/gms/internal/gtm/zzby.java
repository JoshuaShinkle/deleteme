...
public final class zzby {
    ...
    public static zzbz<Long> zzzi = zzbz.zza("analytics.initial_local_dispatch_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
    ...
    public static zzbz<String> zzzu;
    ...
    static {
        ...
        zzzu = zzbz.zza("analytics.batching_strategy.k", zzbgVar.name(), zzbgVar.name());
        String strName = zzbm.GZIP.name();
        zzzv = zzbz.zza("analytics.compression_strategy.k", strName, strName);
        zzzw = zzbz.zza("analytics.max_hits_per_request.k", 20, 20);
        zzzx = zzbz.zza("analytics.max_hit_length.k", UserMetadata.MAX_INTERNAL_KEY_SIZE, UserMetadata.MAX_INTERNAL_KEY_SIZE);
        zzzy = zzbz.zza("analytics.max_post_length.k", UserMetadata.MAX_INTERNAL_KEY_SIZE, UserMetadata.MAX_INTERNAL_KEY_SIZE);
        zzzz = zzbz.zza("analytics.max_batch_post_length", UserMetadata.MAX_INTERNAL_KEY_SIZE, UserMetadata.MAX_INTERNAL_KEY_SIZE);
        ...
        zzaac = zzbz.zza("analytics.service_monitor_interval", DateUtils.MILLIS_PER_DAY, DateUtils.MILLIS_PER_DAY);
        ...
        zzaaf = zzbz.zza("analytics.campaigns.time_limit", DateUtils.MILLIS_PER_DAY, DateUtils.MILLIS_PER_DAY);
        ...
        zzaaj = zzbz.zza("analytics.service_client.idle_disconnect_millis", 10000L, 10000L);
        zzaak = zzbz.zza("analytics.service_client.connect_timeout_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
        zzaal = zzbz.zza("analytics.service_client.second_connect_delay_millis", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
        ...
        zzaao = zzbz.zza("analytics.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY, DateUtils.MILLIS_PER_DAY);
        zzaap = zzbz.zza("analytics.initialization_warning_threshold", DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
