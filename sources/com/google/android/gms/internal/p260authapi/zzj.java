...
public final class zzj implements CredentialsApi {
    ...
    public final PendingIntent getHintPickerIntent(GoogleApiClient googleApiClient, HintRequest hintRequest) {
        ...
        Auth.AuthCredentialsOptions authCredentialsOptionsZzf = ((zzq) googleApiClient.getClient(Auth.zzg)).zzf();
        return zzr.zzc(googleApiClient.getContext(), authCredentialsOptionsZzf, hintRequest, authCredentialsOptionsZzf.getLogSessionId());
    }
