...
class zzec extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i9 = 0;
        if (size >= 0) {
            int iCompareTo = comparable.compareTo(((zzdw) this.zzb.get(size)).zza());
            if (iCompareTo > 0) {
                return -(size + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i9 <= size) {
            int i10 = (i9 + size) / 2;
            int iCompareTo2 = comparable.compareTo(((zzdw) this.zzb.get(i10)).zza());
            if (iCompareTo2 < 0) {
                size = i10 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzl(int i9) {
        zzn();
        Object value = ((zzdw) this.zzb.remove(i9)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i9 = 0; i9 < iZzb; i9++) {
            if (!zzg(i9).equals(zzecVar.zzg(i9))) {
                return false;
            }
        }
        if (iZzb != size) {
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i9 = 0; i9 < iZzb; i9++) {
            iHashCode += ((zzdw) this.zzb.get(i9)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i10 = this.zza;
        if (size == i10) {
            zzdw zzdwVar = (zzdw) this.zzb.remove(i10 - 1);
            zzm().put(zzdwVar.zza(), zzdwVar.getValue());
        }
        this.zzb.add(i9, new zzdw(this, comparable, obj));
        return null;
    }
