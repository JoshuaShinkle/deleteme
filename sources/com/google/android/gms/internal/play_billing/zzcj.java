...
public final class zzcj {
    ...
    static {
        ...
        zzd = zzcjVar4;
        zzcj zzcjVar5 = new zzcj("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        zze = zzcjVar5;
        ...
        zzi = zzcjVar9;
        zzcj zzcjVar10 = new zzcj(C5371i.type, 9, Object.class, Object.class, null);
        zzj = zzcjVar10;
        zzk = new zzcj[]{zzcjVar, zzcjVar2, zzcjVar3, zzcjVar4, zzcjVar5, zzcjVar6, zzcjVar7, zzcjVar8, zzcjVar9, zzcjVar10};
    }

    private zzcj(String str, int i9, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
