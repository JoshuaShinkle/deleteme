...
public final class zzbt {
    ...
    static {
        ...
        zzbt zzbtVar10 = new zzbt(C5371i.type, 9, 9, 1, zzcjVar7);
        zzj = zzbtVar10;
        ...
        zzbt[] zzbtVarArrValues = values();
        zzZ = new zzbt[zzbtVarArrValues.length];
        for (zzbt zzbtVar52 : zzbtVarArrValues) {
            zzZ[zzbtVar52.zzac] = zzbtVar52;
        }
    }

    private zzbt(String str, int i9, int i10, int i11, zzcj zzcjVar) {
        this.zzac = i10;
        this.zzab = zzcjVar;
        int i12 = i11 - 1;
        if (i12 == 1 || i12 == 3) {
