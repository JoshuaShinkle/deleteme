...
public final class zzah extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i9) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, this.zzbx, i9, false);
        SafeParcelWriter.finishObjectHeader(parcel, iBeginObjectHeader);
    }

    @SafeParcelable.Constructor
    public zzah(@SafeParcelable.Param(m17521id = 1) int i9, @SafeParcelable.Param(m17521id = 2) String str, @SafeParcelable.Param(m17521id = 3) PendingIntent pendingIntent) {
        this.zzv = 1;
