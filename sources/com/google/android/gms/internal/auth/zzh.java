...
public final class zzh implements WorkAccountApi {
    ...
    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final void setWorkAuthenticatorEnabled(GoogleApiClient googleApiClient, boolean z8) {
        setWorkAuthenticatorEnabledWithResult(googleApiClient, z8);
    }

    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final PendingResult<Result> setWorkAuthenticatorEnabledWithResult(GoogleApiClient googleApiClient, boolean z8) {
        return googleApiClient.execute(new zzi(this, WorkAccount.API, googleApiClient, z8));
    }
}
