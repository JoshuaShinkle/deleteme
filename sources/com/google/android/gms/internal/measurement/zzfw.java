...
public final class zzfw {
    ...
    public static final class zza extends zzfz {
    ...
    static {
        ...
        try {
            ...
            if (numZza != null) {
                try {
                    zzaVar = numZza.intValue() >= 19 ? new zzgc() : Boolean.getBoolean("com.google.devtools.build.android.desugar.runtime.twr_disable_mimic") ^ true ? new zzga() : new zza();
                } catch (Throwable th) {
                    th = th;
