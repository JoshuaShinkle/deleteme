...
interface zzjw {
    ...
    <T> T zza(zzjv<T> zzjvVar, zzhi zzhiVar);

    void zza(List<Double> list);

    <T> void zza(List<T> list, zzjv<T> zzjvVar, zzhi zzhiVar);

    <K, V> void zza(Map<K, V> map, zzix<K, V> zzixVar, zzhi zzhiVar);

    int zzb();

    @Deprecated
    <T> T zzb(zzjv<T> zzjvVar, zzhi zzhiVar);

    void zzb(List<Float> list);

    @Deprecated
    <T> void zzb(List<T> list, zzjv<T> zzjvVar, zzhi zzhiVar);
