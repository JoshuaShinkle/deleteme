...
public final class zzlx implements zzly {
    ...
    static {
        ...
        zzb = zzdlVar.zza("measurement.config.cache_time", DateUtils.MILLIS_PER_DAY);
        ...
        zzk = zzdlVar.zza("measurement.alarm_manager.minimum_interval", 60000L);
        zzl = zzdlVar.zza("measurement.upload.minimum_delay", 500L);
        zzm = zzdlVar.zza("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        ...
        zzp = zzdlVar.zza("measurement.config.cache_time.service", DateUtils.MILLIS_PER_HOUR);
        ...
        zzs = zzdlVar.zza("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzv = zzdlVar.zza("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzaj = zzdlVar.zza("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
    }
