...
public final class zzj implements People {
    ...
    @VisibleForTesting
    @SuppressLint({"MissingRemoteException"})
    public final PendingResult<People.LoadPeopleResult> loadVisible(GoogleApiClient googleApiClient, int i9, String str) {
        return googleApiClient.enqueue(new zzk(this, googleApiClient, i9, str));
    }
