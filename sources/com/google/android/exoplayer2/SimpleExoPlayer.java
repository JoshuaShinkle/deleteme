...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
    ...
    public final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
        ...
        public void onAudioDecoderInitialized(String str, long j9, long j10) {
            ...
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioDecoderInitialized(str, j9, j10);
            }
        }
        ...
        public void onAudioSessionId(int i9) {
            SimpleExoPlayer.this.audioSessionId = i9;
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSessionId(i9);
            }
        }
        ...
        public void onAudioSinkUnderrun(int i9, long j9, long j10) {
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSinkUnderrun(i9, j9, j10);
            }
        }
        ...
        public void onDroppedFrames(int i9, long j9) {
            ...
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onDroppedFrames(i9, j9);
            }
        }
        ...
        public void onVideoDecoderInitialized(String str, long j9, long j10) {
            Iterator it = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onVideoDecoderInitialized(str, j9, j10);
            }
        }
        ...
        public void onVideoSizeChanged(int i9, int i10, int i11, float f9) {
            Iterator it = SimpleExoPlayer.this.videoListeners.iterator();
            while (it.hasNext()) {
                ((com.google.android.exoplayer2.video.VideoListener) it.next()).onVideoSizeChanged(i9, i10, i11, f9);
            }
            Iterator it2 = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it2.hasNext()) {
                ((VideoRendererEventListener) it2.next()).onVideoSizeChanged(i9, i10, i11, f9);
            }
        }
    ...
    public void setAudioStreamType(int i9) {
        int audioUsageForStreamType = Util.getAudioUsageForStreamType(i9);
        setAudioAttributes(new AudioAttributes.Builder().setUsage(audioUsageForStreamType).setContentType(Util.getAudioContentTypeForStreamType(i9)).build());
    }
    ...
    public void setVideoScalingMode(int i9) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 2) {
                this.player.createMessage(renderer).setType(4).setPayload(Integer.valueOf(i9)).send();
            }
        }
    }
    ...
    public void setVolume(float f9) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 1) {
                this.player.createMessage(renderer).setType(2).setPayload(Float.valueOf(f9)).send();
            }
        }
    }
    ...
    public SimpleExoPlayer(RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, Clock clock) {
        ...
        Renderer[] rendererArrCreateRenderers = renderersFactory.createRenderers(new Handler(Looper.myLooper() != null ? Looper.myLooper() : Looper.getMainLooper()), componentListener, componentListener, componentListener, componentListener);
        this.renderers = rendererArrCreateRenderers;
        this.audioVolume = 1.0f;
        this.audioSessionId = 0;
        this.audioAttributes = AudioAttributes.DEFAULT;
        this.videoScalingMode = 1;
        this.player = createExoPlayerImpl(rendererArrCreateRenderers, trackSelector, loadControl, clock);
    }
