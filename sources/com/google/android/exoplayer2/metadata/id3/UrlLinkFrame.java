...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f15312id.equals(urlLinkFrame.f15312id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }

    public int hashCode() {
        int iHashCode = (527 + this.f15312id.hashCode()) * 31;
