...
public final class DefaultDataSource implements DataSource {
    ...
    public int read(byte[] bArr, int i9, int i10) {
        return this.dataSource.read(bArr, i9, i10);
    }

    public DefaultDataSource(Context context, TransferListener<? super DataSource> transferListener, String str, int i9, int i10, boolean z8) {
        this(context, transferListener, new DefaultHttpDataSource(str, null, transferListener, i9, i10, z8, null));
    }
