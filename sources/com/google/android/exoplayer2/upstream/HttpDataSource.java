...
public interface HttpDataSource extends DataSource {
    ...
    public static final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        public InvalidResponseCodeException(int i9, Map<String, List<String>> map, DataSpec dataSpec) {
            super("Response code: " + i9, dataSpec, 1);
    ...
    public static class HttpDataSourceException extends IOException {
        ...
        public HttpDataSourceException(DataSpec dataSpec, int i9) {
            this.dataSpec = dataSpec;
            this.type = i9;
        }

        public HttpDataSourceException(String str, DataSpec dataSpec, int i9) {
            super(str);
            this.dataSpec = dataSpec;
            this.type = i9;
        }

        public HttpDataSourceException(IOException iOException, DataSpec dataSpec, int i9) {
            super(iOException);
            this.dataSpec = dataSpec;
            this.type = i9;
        }

        public HttpDataSourceException(String str, IOException iOException, DataSpec dataSpec, int i9) {
