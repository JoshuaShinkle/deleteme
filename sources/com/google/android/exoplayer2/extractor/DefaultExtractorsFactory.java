...
import com.google.android.exoplayer2.extractor.p037ts.Ac3Extractor;
...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    public synchronized DefaultExtractorsFactory setFragmentedMp4ExtractorFlags(int i9) {
        this.fragmentedMp4Flags = i9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setMatroskaExtractorFlags(int i9) {
        this.matroskaFlags = i9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setMp3ExtractorFlags(int i9) {
        this.mp3Flags = i9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setMp4ExtractorFlags(int i9) {
        this.mp4Flags = i9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setTsExtractorFlags(int i9) {
        this.tsFlags = i9;
        return this;
    }

    public synchronized DefaultExtractorsFactory setTsExtractorMode(int i9) {
        this.tsMode = i9;
        return this;
    }
}
