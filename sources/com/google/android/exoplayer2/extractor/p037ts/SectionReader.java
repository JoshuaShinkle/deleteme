...
public final class SectionReader implements TsPayloadReader {
    ...
    public void consume(ParsableByteArray parsableByteArray, boolean z8) {
        int position = z8 ? parsableByteArray.getPosition() + parsableByteArray.readUnsignedByte() : -1;
            ...
            if (i9 < 3) {
                ...
                if (i10 == 3) {
                    ...
                    if (iCapacity < i11) {
                        ...
                        parsableByteArray2.reset(Math.min(MAX_SECTION_LENGTH, Math.max(i11, bArr.length * 2)));
