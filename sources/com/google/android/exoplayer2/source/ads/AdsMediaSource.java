...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public final class AdPrepareErrorListener implements DeferredMediaPeriod.PrepareErrorListener {
        ...
        public AdPrepareErrorListener(int i9, int i10) {
    ...
    private void maybeUpdateSourceInfo() {
        ...
        this.listener.onSourceInfoRefreshed(this, adPlaybackStateWithAdDurationsUs.adGroupCount == 0 ? this.contentTimeline : new SinglePeriodAdTimeline(this.contentTimeline, this.adPlaybackState), this.contentManifest);
    }
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator) {
        ...
        if (this.adGroupMediaSources[i9].length <= i10) {
            MediaSource mediaSourceCreateMediaSource = this.adMediaSourceFactory.createMediaSource(this.adPlaybackState.adGroups[i9].uris[i10], this.eventHandler, this.eventListener);
            MediaSource[][] mediaSourceArr = this.adGroupMediaSources;
            int length = mediaSourceArr[mediaPeriodId.adGroupIndex].length;
            if (i10 >= length) {
                int i11 = i10 + 1;
                mediaSourceArr[i9] = (MediaSource[]) Arrays.copyOf(mediaSourceArr[i9], i11);
                long[][] jArr = this.adDurationsUs;
                jArr[i9] = Arrays.copyOf(jArr[i9], i11);
                Arrays.fill(this.adDurationsUs[i9], length, i11, C3322C.TIME_UNSET);
            }
            this.adGroupMediaSources[i9][i10] = mediaSourceCreateMediaSource;
        ...
        deferredMediaPeriod2.setPrepareErrorListener(new AdPrepareErrorListener(i9, i10));
        List<DeferredMediaPeriod> list = this.deferredMediaPeriodByAdMediaSource.get(mediaSource);
        if (list == null) {
    ...
    public void prepareSource(final ExoPlayer exoPlayer, boolean z8, MediaSource.Listener listener) {
