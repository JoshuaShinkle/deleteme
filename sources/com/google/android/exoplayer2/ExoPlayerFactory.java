...
public final class ExoPlayerFactory {
    ...
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int i9) {
        return newSimpleInstance(new DefaultRenderersFactory(context, drmSessionManager, i9), trackSelector, loadControl);
    }

    @Deprecated
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int i9, long j9) {
        return newSimpleInstance(new DefaultRenderersFactory(context, drmSessionManager, i9, j9), trackSelector, loadControl);
    }
