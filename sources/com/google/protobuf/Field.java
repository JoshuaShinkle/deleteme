...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    public static /* synthetic */ class C43981 {
        ...
        static final /* synthetic */ int[] f15629xa1df5c61;

        static {
            int[] iArr = new int[GeneratedMessageLite.MethodToInvoke.values().length];
            f15629xa1df5c61 = iArr;
            try {
                iArr[GeneratedMessageLite.MethodToInvoke.NEW_MUTABLE_INSTANCE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f15629xa1df5c61[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Field, Builder> implements FieldOrBuilder {
        public /* synthetic */ Builder(C43981 c43981) {
            this();
        }
        ...
        public Builder setCardinalityValue(int i9) {
            copyOnWrite();
        ...
        public Builder setKindValue(int i9) {
            copyOnWrite();
        ...
        public Builder setOneofIndex(int i9) {
            copyOnWrite();
        ...
        public Builder setPacked(boolean z8) {
            copyOnWrite();
        ...
        public Builder setOptions(int i9, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i9, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i9, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i9, builder.build());
            return this;
        }
    }
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        private static final Internal.EnumLiteMap<Cardinality> internalValueMap = new Internal.EnumLiteMap<Cardinality>() { // from class: com.google.protobuf.Field.Cardinality.1
            ...
            public Cardinality findValueByNumber(int i9) {
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        C43981 c43981 = null;
        switch (C43981.f15629xa1df5c61[methodToInvoke.ordinal()]) {
            case 1:
                return new Field();
            case 2:
                return new Builder(c43981);
            case 3:
