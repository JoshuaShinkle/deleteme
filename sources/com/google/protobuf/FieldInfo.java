...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(C44011 c44011) {
            this();
        }
    ...
    private FieldInfo(java.lang.reflect.Field field, int i9, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i10, boolean z8, boolean z9, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    public static FieldInfo forField(java.lang.reflect.Field field, int i9, FieldType fieldType, boolean z8) {
        checkFieldNumber(i9);
        ...
        return new FieldInfo(field, i9, fieldType, null, null, 0, false, z8, null, null, null, null, null);
    }
    ...
    public static FieldInfo forOneofMemberField(int i9, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z8, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i9);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i9, fieldType, null, null, 0, false, z8, oneofInfo, cls, null, enumVerifier, null);
        }
    ...
    public static FieldInfo forProto2OptionalField(java.lang.reflect.Field field, int i9, FieldType fieldType, java.lang.reflect.Field field2, int i10, boolean z8, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i9);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i10)) {
            return new FieldInfo(field, i9, fieldType, null, field2, i10, false, z8, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i10);
    }

    public static FieldInfo forProto2RequiredField(java.lang.reflect.Field field, int i9, FieldType fieldType, java.lang.reflect.Field field2, int i10, boolean z8, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i9);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i10)) {
            return new FieldInfo(field, i9, fieldType, null, field2, i10, true, z8, null, null, null, enumVerifier, null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i10);
    }
    ...
    public Class<?> getMessageFieldClass() {
        int i9 = C44011.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i9 == 1 || i9 == 2) {
