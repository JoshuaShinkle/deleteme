...
final class Protobuf {
    ...
    public <T> void mergeFrom(T t8, Reader reader) {
    ...
    public <T> void writeTo(T t8, Writer writer) {
        schemaFor((Protobuf) t8).writeTo(t8, writer);
    }

    public <T> void mergeFrom(T t8, Reader reader, ExtensionRegistryLite extensionRegistryLite) {
