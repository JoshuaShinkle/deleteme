...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i9, int i10);

    MessageType parseFrom(byte[] bArr, int i9, int i10, ExtensionRegistryLite extensionRegistryLite);
    ...
    MessageType parsePartialFrom(byte[] bArr, int i9, int i10);

    MessageType parsePartialFrom(byte[] bArr, int i9, int i10, ExtensionRegistryLite extensionRegistryLite);
