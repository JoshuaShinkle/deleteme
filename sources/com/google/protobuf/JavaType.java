...
public final class JavaType {
    ...
    static {
        ...
        LONG = javaType3;
        JavaType javaType4 = new JavaType("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(BitmapDescriptorFactory.HUE_RED));
        FLOAT = javaType4;
        ...
        ENUM = javaType9;
        JavaType javaType10 = new JavaType(C5371i.type, 9, Object.class, Object.class, null);
        MESSAGE = javaType10;
        $VALUES = new JavaType[]{javaType, javaType2, javaType3, javaType4, javaType5, javaType6, javaType7, javaType8, javaType9, javaType10};
    }

    private JavaType(String str, int i9, Class cls, Class cls2, Object obj) {
        this.type = cls;
        this.boxedType = cls2;
