...
public final class FieldType {
    ...
    /* renamed from: id */
    private final int f15631id;
    private final JavaType javaType;
    private final boolean primitiveScalar;

    /* renamed from: com.google.protobuf.FieldType$1 */
    public static /* synthetic */ class C44041 {
    ...
    static {
        ...
        FieldType fieldType10 = new FieldType(C5371i.type, 9, 9, collection, javaType7);
        MESSAGE = fieldType10;
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f15631id] = fieldType52;
        }
    }

    private FieldType(String str, int i9, int i10, Collection collection, JavaType javaType) {
        int i11;
        this.f15631id = i10;
        this.collection = collection;
        this.javaType = javaType;
        int i12 = C44041.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i12 == 1 || i12 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i11 = C44041.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i11 == 2 || i11 == 3) ? false : true;
    }

    public static FieldType forId(int i9) {
        if (i9 < 0) {
            return null;
        }
        FieldType[] fieldTypeArr = VALUES;
        if (i9 >= fieldTypeArr.length) {
            return null;
        }
        return fieldTypeArr[i9];
    }
