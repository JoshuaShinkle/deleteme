...
public class MapEntryLite<K, V> {
    ...
    public static /* synthetic */ class C44141 {
    ...
    private MapEntryLite(WireFormat.FieldType fieldType, K k9, WireFormat.FieldType fieldType2, V v8) {
        this.metadata = new Metadata<>(fieldType, k9, fieldType2, v8);
        this.key = k9;
        this.value = v8;
    }

    public static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k9, V v8) {
        return FieldSet.computeElementSize(metadata.keyType, 1, k9) + FieldSet.computeElementSize(metadata.valueType, 2, v8);
    }

    public static <K, V> MapEntryLite<K, V> newDefaultInstance(WireFormat.FieldType fieldType, K k9, WireFormat.FieldType fieldType2, V v8) {
        return new MapEntryLite<>(fieldType, k9, fieldType2, v8);
    }

    public static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t8) {
        int i9 = C44141.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()];
        if (i9 == 1) {
    ...
    public static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k9, V v8) {
        FieldSet.writeElement(codedOutputStream, metadata.keyType, 1, k9);
        FieldSet.writeElement(codedOutputStream, metadata.valueType, 2, v8);
    }

    public int computeMessageSize(int i9, K k9, V v8) {
        return CodedOutputStream.computeTagSize(i9) + CodedOutputStream.computeLengthDelimitedFieldSize(computeSerializedSize(this.metadata, k9, v8));
    }
    ...
    public void serializeTo(CodedOutputStream codedOutputStream, int i9, K k9, V v8) {
        codedOutputStream.writeTag(i9, 2);
        codedOutputStream.writeUInt32NoTag(computeSerializedSize(this.metadata, k9, v8));
        writeTo(codedOutputStream, this.metadata, k9, v8);
    }
    ...
    private MapEntryLite(Metadata<K, V> metadata, K k9, V v8) {
