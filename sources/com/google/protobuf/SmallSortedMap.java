...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public class DescendingEntryIterator implements Iterator<Map.Entry<K, V>> {
        ...
        public boolean hasNext() {
            int i9 = this.pos;
            return (i9 > 0 && i9 <= SmallSortedMap.this.entryList.size()) || getOverflowIterator().hasNext();
        }
    ...
    public static <FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> SmallSortedMap<FieldDescriptorType, Object> newFieldMap(int i9) {
        return (SmallSortedMap<FieldDescriptorType, Object>) new SmallSortedMap<FieldDescriptorType, Object>(i9) { // from class: com.google.protobuf.SmallSortedMap.1
            ...
            public /* bridge */ /* synthetic */ Object put(Object obj, Object obj2) {
                return super.put((C44231<FieldDescriptorType>) obj, (FieldSet.FieldDescriptorLite) obj2);
            }
        };
    }
    ...
    public boolean equals(Object obj) {
        ...
        for (int i9 = 0; i9 < numArrayEntries; i9++) {
            if (!getArrayEntryAt(i9).equals(smallSortedMap.getArrayEntryAt(i9))) {
                return false;
            }
        }
    ...
    public int hashCode() {
        ...
        int iHashCode = 0;
        for (int i9 = 0; i9 < numArrayEntries; i9++) {
            iHashCode += this.entryList.get(i9).hashCode();
        }
