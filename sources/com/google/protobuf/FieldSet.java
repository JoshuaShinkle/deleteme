...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap) {
            for (int i9 = 0; i9 < smallSortedMap.getNumArrayEntries(); i9++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i9));
            }
        ...
        public void addRepeatedField(T t8, Object obj) {
            ...
            verifyType(t8.getLiteType(), obj);
            Object field = getField(t8);
            if (field == null) {
                arrayList = new ArrayList();
                this.fields.put((SmallSortedMap<T, Object>) t8, (T) arrayList);
            } else {
        ...
        public Object getField(T t8) {
            return replaceBuilders(t8, getFieldAllowBuilders(t8));
        }

        public Object getFieldAllowBuilders(T t8) {
            Object obj = this.fields.get(t8);
            return obj instanceof LazyField ? ((LazyField) obj).getValue() : obj;
        }

        public Object getRepeatedField(T t8, int i9) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t8, i9));
        }

        public Object getRepeatedFieldAllowBuilders(T t8, int i9) {
            if (!t8.isRepeated()) {
        ...
        public boolean isInitialized() {
            for (int i9 = 0; i9 < this.fields.getNumArrayEntries(); i9++) {
                if (!FieldSet.isInitialized(this.fields.getArrayEntryAt(i9))) {
                    return false;
                }
            }
        ...
        public void mergeFrom(FieldSet<T> fieldSet) {
            ensureIsMutable();
            for (int i9 = 0; i9 < ((FieldSet) fieldSet).fields.getNumArrayEntries(); i9++) {
                mergeFromField(((FieldSet) fieldSet).fields.getArrayEntryAt(i9));
            }
        ...
        public void setField(T t8, Object obj) {
            ...
            if (!t8.isRepeated()) {
                ...
                for (Object obj2 : arrayList) {
                    verifyType(t8.getLiteType(), obj2);
        ...
        public void setRepeatedField(T t8, int i9, Object obj) {
            ensureIsMutable();
            if (!t8.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t8, Object obj) {
                ...
                if (obj instanceof List) {
                    ...
                    for (int i9 = 0; i9 < arrayList.size(); i9++) {
                        ...
                        if (objReplaceBuilder != obj2) {
                            ...
                            arrayList.set(i9, objReplaceBuilder);
                        }
                    }
                    return arrayList;
                }
    ...
    public /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C44031 c44031) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z8) {
        ...
        for (int i9 = 0; i9 < smallSortedMap.getNumArrayEntries(); i9++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i9), z8);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it.next(), z8);
        }
    ...
    public static int computeElementSize(WireFormat.FieldType fieldType, int i9, Object obj) {
    ...
    public static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (C44031.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    public static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C44031.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 7:
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C44031) null);
    }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z8) {
        return z8 ? WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.STRICT) : WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.LOOSE);
    }
    ...
    public static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i9, Object obj) {
        if (fieldType == WireFormat.FieldType.GROUP) {
    ...
    public void setField(T t8, Object obj) {
        if (!t8.isRepeated()) {
            ...
            while (it.hasNext()) {
                verifyType(t8.getLiteType(), it.next());
            }
            obj = arrayList;
        }
        if (obj instanceof LazyField) {
