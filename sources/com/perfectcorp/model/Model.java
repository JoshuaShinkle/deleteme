...
public abstract class Model {
    ...
    public static <T extends Model> T parseFromJSON(Class<T> cls, String str) {
    ...
    public static <T extends Model> T parseFromJSONObject(Class<T> cls, JSONObject jSONObject) throws IllegalAccessException, InstantiationException, SecurityException, IllegalArgumentException {
        try {
                ...
                if (Modifier.isPublic(modifiers) && !Modifier.isStatic(modifiers) && !Modifier.isTransient(modifiers)) {
                    ...
                    try {
                        if (type.equals(Long.class) || type.equals(Long.TYPE)) {
                            ...
                            field.set(tNewInstance, jSONObject.getJSONObject(name));
                        }
                    } catch (Exception unused) {
                    }
                }
    ...
    public static <T> String toJSON(Model model) {
