...
public interface INotificationSideChannel extends IInterface {
    ...
    public static class Default implements INotificationSideChannel {
        ...
        public void cancel(String str, int i9, String str2) {
        }
        ...
        @Override // android.support.v4.app.INotificationSideChannel
        public void notify(String str, int i9, String str2, Notification notification) {
        }
    }
        ...
        public static class Proxy implements INotificationSideChannel {
            ...
            public void cancel(String str, int i9, String str2) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().cancel(str, i9, str2);
                } finally {
            ...
            public void notify(String str, int i9, String str2, Notification notification) {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().notify(str, i9, str2, notification);
                } finally {
                    parcelObtain.recycle();
                }
            }
    ...
    void cancel(String str, int i9, String str2);

    void cancelAll(String str);

    void notify(String str, int i9, String str2, Notification notification);
}
