...
public interface IMediaSession extends IInterface {
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i9);

    void adjustVolume(int i9, int i10, String str);
    ...
    void setVolumeTo(int i9, int i10, String str);

    void skipToQueueItem(long j9);
