...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((C5266e) message.obj);
                }
            }
        }
        ...
        public class StubApi21 implements MediaSessionCompatApi21.Callback {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            C6229d.m23807b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
                    ...
                    int i9 = bundle.getInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, -1);
                    if (i9 >= 0 && i9 < mediaSessionImplApi212.mQueue.size()) {
                        queueItem = mediaSessionImplApi212.mQueue.get(i9);
                    }
                    if (queueItem != null) {
            ...
            public void onSkipToQueueItem(long j9) {
                Callback.this.onSkipToQueueItem(j9);
            }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(C5266e c5266e) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(c5266e);
                if (z8 && z10) {
                    onPause();
                } else if (!z8 && z9) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C5266e currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        C5266e getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C5266e c5266e);
        ...
        void setPlaybackToLocal(int i9);

        void setPlaybackToRemote(AbstractC5271j abstractC5271j);

        void setQueue(List<QueueItem> list);

        void setQueueTitle(CharSequence charSequence);

        void setRatingType(int i9);

        void setRepeatMode(int i9);

        void setSessionActivity(PendingIntent pendingIntent);

        void setShuffleMode(int i9);
    }
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j9) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j9);
            return (j9 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi18.1
                    ...
                    public void onPlaybackPositionUpdate(long j9) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(j9), null);
                    }
                });
            }
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j9) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j9);
            return (j9 & 128) != 0 ? rccTransportControlFlagsFromActions | 512 : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final C5266e getCurrentControllerInfo() {
            return new C5266e(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(C5266e c5266e) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C5266e mRemoteUserInfo;
        int mRepeatMode;
        ...
        AbstractC5271j mVolumeProvider;
        int mVolumeType;
        ...
        private AbstractC5271j.a mVolumeCallback = new AbstractC5271j.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // p123l0.AbstractC5271j.a
            public void onVolumeChanged(AbstractC5271j abstractC5271j) {
                MediaSessionImplBase.this.getClass();
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                int i9 = mediaSessionImplBase.mVolumeType;
                int i10 = mediaSessionImplBase.mLocalStream;
                throw null;
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i9) {
                postToHandler(26, mediaDescriptionCompat, i9);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int i9, int i10, String str) {
                MediaSessionImplBase.this.adjustVolume(i9, i10);
            }
            ...
            public long getFlags() {
                long j9;
                synchronized (MediaSessionImplBase.this.mLock) {
                    j9 = MediaSessionImplBase.this.mFlags;
                }
                return j9;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    i9 = mediaSessionImplBase.mVolumeType;
                    i10 = mediaSessionImplBase.mLocalStream;
                    mediaSessionImplBase.getClass();
                    if (i9 == 2) {
                        throw null;
                    }
                    streamMaxVolume = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(i10);
                    streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i10);
                }
                return new ParcelableVolumeInfo(i9, i10, 2, streamMaxVolume, streamVolume);
            }
            ...
            public void postToHandler(int i9) {
                MediaSessionImplBase.this.postToHandler(i9, 0, 0, null, null);
            }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C5266e("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
            ...
            public boolean sendMediaButton(KeyEvent keyEvent) {
                boolean z8 = (MediaSessionImplBase.this.mFlags & 1) != 0;
                if (z8) {
            ...
            public void setCaptioningEnabled(boolean z8) {
                postToHandler(29, Boolean.valueOf(z8));
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int i9, int i10, String str) {
                MediaSessionImplBase.this.setVolumeTo(i9, i10);
            }
            ...
            public void postToHandler(int i9, int i10) {
                MediaSessionImplBase.this.postToHandler(i9, i10, 0, null, null);
            }

            public void postToHandler(int i9, Object obj) {
                MediaSessionImplBase.this.postToHandler(i9, 0, 0, obj, null);
            }

            public void postToHandler(int i9, Object obj, int i10) {
                MediaSessionImplBase.this.postToHandler(i9, i10, 0, obj, null);
            }

            public void postToHandler(int i9, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(i9, 0, 0, obj, bundle);
            }
        }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new C5266e(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
                ...
                try {
                    switch (message.what) {
                        ...
                        case 28:
                            ...
                            if (list != null) {
                                int i9 = message.arg1;
                                QueueItem queueItem = (i9 < 0 || i9 >= list.size()) ? null : MediaSessionImplBase.this.mQueue.get(message.arg1);
                                if (queueItem != null) {
        ...
        private void sendCaptioningEnabled(boolean z8) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z8);
        ...
        private void sendRepeatMode(int i9) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i9);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i9) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i9);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        public void adjustVolume(int i9, int i10) {
            ...
            this.mAudioManager.adjustStreamVolume(this.mLocalStream, i9, i10);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public C5266e getCurrentControllerInfo() {
            C5266e c5266e;
            synchronized (this.mLock) {
                c5266e = this.mRemoteUserInfo;
            }
            return c5266e;
        }
        ...
        public int getRccStateFromState(int i9) {
            switch (i9) {
                case 0:
                    return 0;
                case 1:
        ...
        public void postToHandler(int i9, int i10, int i11, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message messageObtainMessage = messageHandler.obtainMessage(i9, i10, i11, obj);
                    Bundle bundle2 = new Bundle();
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(AbstractC5271j abstractC5271j) {
        ...
        public void setVolumeTo(int i9, int i10) {
            ...
            this.mAudioManager.setStreamVolume(this.mLocalStream, i9, i10);
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(C6229d.m23806a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
        ...
        public Bundle toBundle() {
            ...
            if (iMediaSession != null) {
                C6229d.m23807b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
            }
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (j9 < 0 || playbackSpeed <= j9) ? playbackSpeed < 0 ? 0L : playbackSpeed : j9, playbackStateCompat.getPlaybackSpeed(), jElapsedRealtime).build();
    }
    ...
    public void setCaptioningEnabled(boolean z8) {
        this.mImpl.setCaptioningEnabled(z8);
    }
    ...
    public void setPlaybackToLocal(int i9) {
        this.mImpl.setPlaybackToLocal(i9);
    }
    ...
    public void setRatingType(int i9) {
        this.mImpl.setRatingType(i9);
    }

    public void setRepeatMode(int i9) {
        this.mImpl.setRepeatMode(i9);
    }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        @Override // android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i9) {
            this.mResultReceiver.writeToParcel(parcel, i9);
        }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = MediaButtonReceiver.m2193a(context)) == null) {
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C5266e(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public void setCaptioningEnabled(boolean z8) {
            if (this.mCaptioningEnabled != z8) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z8);
                    } catch (RemoteException unused) {
                    }
                }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setFlags(int i9) {
            MediaSessionCompatApi21.setFlags(this.mSessionObj, i9);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToLocal(int i9) {
            MediaSessionCompatApi21.setPlaybackToLocal(this.mSessionObj, i9);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setRatingType(int i9) {
            MediaSessionCompatApi22.setRatingType(this.mSessionObj, i9);
        }
        ...
        public void setRepeatMode(int i9) {
            if (this.mRepeatMode != i9) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i9);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i9) {
            if (this.mShuffleMode != i9) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i9);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
