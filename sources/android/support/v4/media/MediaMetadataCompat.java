...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final C5302a<String, Integer> METADATA_KEYS_TYPE;
    ...
    static {
        C5302a<String, Integer> c5302a = new C5302a<>();
        METADATA_KEYS_TYPE = c5302a;
        c5302a.put(METADATA_KEY_TITLE, 1);
        c5302a.put(METADATA_KEY_ARTIST, 1);
        c5302a.put(METADATA_KEY_DURATION, 0);
        c5302a.put(METADATA_KEY_ALBUM, 1);
        c5302a.put(METADATA_KEY_AUTHOR, 1);
        c5302a.put(METADATA_KEY_WRITER, 1);
        c5302a.put(METADATA_KEY_COMPOSER, 1);
        c5302a.put(METADATA_KEY_COMPILATION, 1);
        c5302a.put(METADATA_KEY_DATE, 1);
        c5302a.put(METADATA_KEY_YEAR, 0);
        c5302a.put(METADATA_KEY_GENRE, 1);
        c5302a.put(METADATA_KEY_TRACK_NUMBER, 0);
        c5302a.put(METADATA_KEY_NUM_TRACKS, 0);
        c5302a.put(METADATA_KEY_DISC_NUMBER, 0);
        c5302a.put(METADATA_KEY_ALBUM_ARTIST, 1);
        c5302a.put(METADATA_KEY_ART, 2);
        c5302a.put(METADATA_KEY_ART_URI, 1);
        c5302a.put(METADATA_KEY_ALBUM_ART, 2);
        c5302a.put(METADATA_KEY_ALBUM_ART_URI, 1);
        c5302a.put(METADATA_KEY_USER_RATING, 3);
        c5302a.put(METADATA_KEY_RATING, 3);
        c5302a.put(METADATA_KEY_DISPLAY_TITLE, 1);
        c5302a.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        c5302a.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        c5302a.put(METADATA_KEY_DISPLAY_ICON, 2);
        c5302a.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        c5302a.put(METADATA_KEY_MEDIA_ID, 1);
        c5302a.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        c5302a.put(METADATA_KEY_MEDIA_URI, 1);
        c5302a.put(METADATA_KEY_ADVERTISEMENT, 0);
        c5302a.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    public Bitmap getBitmap(String str) {
        try {
            ...
            Log.w(TAG, "Failed to retrieve a key as Bitmap.", e9);
            return null;
        }
    }
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            while (i9 < 3) {
                ...
                int i11 = i10 + 1;
                CharSequence text2 = getText(strArr[i10]);
                if (!TextUtils.isEmpty(text2)) {
                    charSequenceArr[i9] = text2;
                    i9++;
                }
                i10 = i11;
            }
        ...
        while (true) {
            ...
            String string2 = getString(strArr3[i13]);
    ...
    public RatingCompat getRating(String str) {
        try {
            ...
            Log.w(TAG, "Failed to retrieve a key as Rating.", e9);
            return null;
        }
    }
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap, int i9) {
            float f9 = i9;
            float fMin = Math.min(f9 / bitmap.getWidth(), f9 / bitmap.getHeight());
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            C5302a<String, Integer> c5302a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c5302a.containsKey(str) || c5302a.get(str).intValue() == 2) {
        ...
        public Builder putLong(String str, long j9) {
            C5302a<String, Integer> c5302a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c5302a.containsKey(str) || c5302a.get(str).intValue() == 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            C5302a<String, Integer> c5302a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c5302a.containsKey(str) || c5302a.get(str).intValue() == 3) {
        ...
        public Builder putString(String str, String str2) {
            C5302a<String, Integer> c5302a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c5302a.containsKey(str) || c5302a.get(str).intValue() == 1) {
        ...
        public Builder(MediaMetadataCompat mediaMetadataCompat, int i9) {
